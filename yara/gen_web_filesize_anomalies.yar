rule SUSP_Filesize_Exfil {
   meta:
      ...
      score = 60
   condition:
      ( extension == ".css" or extension == ".js" or extension == ".php" or extension == ".html" or extension == ".htm"  
      or extension == ".asp" or extension == ".aspx" or extension == ".jsp" or extension == ".gif" or extension == ".jpg"
      or extension == ".png" or extension == ".jpeg" or extension == ".txt" or extension == ".woff" or extension == ".json" 
      or extension == ".xml" or extension == ".svg") 
	  and
