...
rule Weevely_Webshell {
	meta:
		...
		date = "2014/12/14"
		score = 60
		uuid = "12aa177a-4ebc-5ed8-a81b-34ec83395ec4"
	strings:
...
rule webshell_h4ntu_shell_powered_by_tsoi_ {
	meta:
		...
		uuid = "393e738a-b4c2-5630-a55f-c3caee4ff75e"
	strings:
...
rule webshell_phpspy_2005_full_phpspy_2005_lite_PHPSPY {
	meta:
		...
		uuid = "41a0560a-b22e-5028-8ad1-710c5758cb1d"
	strings:
...
rule webshell_c99_c99shell_c99_w4cking_Shell_xxx {
	meta:
		...
		uuid = "ce88027c-ae08-59f3-948d-6f3d58515468"
	strings:
...
rule perlbot_pl {
	meta:
		...
		uuid = "378cb0e4-2069-50b7-ab3e-5a81055e9983"
	strings:
...
rule php_backdoor_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "2b5cb105c4ea9b5ebc64705b4bd86bf7"
		uuid = "aca53071-f793-538d-bbeb-34469cdb4d1f"
	strings:
...
rule Liz0ziM_Private_Safe_Mode_Command_Execuriton_Bypass_Exploit_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "c6eeacbe779518ea78b8f7ed5f63fc11"
		uuid = "e91114ce-18f9-51cd-b41c-b796960ea4fe"
	strings:
...
rule Nshell__1__php_php {
	meta:
		...
		uuid = "44e8b6c5-6f41-5c37-a083-26acedd91956"
	strings:
...
rule shankar_php_php {
	meta:
		...
		uuid = "0c8ab3eb-574b-5e5a-8117-4efecef94f83"
	strings:
		$sAuthor = "ShAnKaR"
...
rule Casus15_php_php {
	meta:
		...
		uuid = "ba6748a2-fb80-5eda-816c-155bab9285e5"
	strings:
...
rule small_php_php {
	meta:
		...
		uuid = "cf4fb88f-a312-560d-be0b-b55bfcb889be"
	strings:
...
rule shellbot_pl {
	meta:
		...
		uuid = "07c145b1-c9f7-564a-b354-a6d2072f380c"
	strings:
		$s0 = "ShellBOT"
		$s1 = "PacktsGr0up"
		$s2 = "CoRpOrAtIoN"
...
rule fuckphpshell_php {
	meta:
		...
		uuid = "010db63b-ff72-5f97-8651-a1c7851471ff"
	strings:
		$s0 = "$succ = \"Warning! "
...
rule ngh_php_php {
	meta:
		...
		uuid = "2d8ff3c1-d6b3-57ce-8213-232b376dbd05"
	strings:
		$s0 = "Cr4sh_aka_RKL"
		$s1 = "NGH edition"
...
rule jsp_reverse_jsp {
	meta:
		...
		uuid = "4953b230-4cd9-55d6-a3cb-8d3713e7fb0c"
	strings:
		$s0 = "// backdoor.jsp"
...
rule Tool_asp {
	meta:
		...
		uuid = "e5e727bd-836b-5540-8755-40f37904bc03"
	strings:
...
rule NT_Addy_asp {
	meta:
		...
		uuid = "18f5f360-8690-5e09-ac18-b8cc4f678811"
	strings:
...
rule SimAttacker___Vrsion_1_0_0___priv8_4_My_friend_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "089ff24d978aeff2b4b2869f0c7d38a3"
		uuid = "8a34f4fd-337d-5eb4-b7b7-4adb1c2b7937"
	strings:
...
rule RemExp_asp {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "aa1d8491f4e2894dbdb91eec1abc2244"
		uuid = "900036ce-ff13-5441-bb77-906ea08a4ca0"
	strings:
...
rule phvayvv_php_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "35fb37f3c806718545d97c6559abd262"
		uuid = "76351a59-8f52-5110-a9b8-36edd59026df"
	strings:
...
rule klasvayv_asp {
	meta:
		...
		uuid = "3ca4c20c-f879-55a0-9070-d40fc903f9ae"
	strings:
...
rule r57shell_php_php {
	meta:
		...
		uuid = "1f1070e8-e82c-5cae-a64a-cd5028adae97"
	strings:
...
rule rst_sql_php_php {
	meta:
		...
		uuid = "41730336-0dce-5ed9-95b0-c911a4e3cb48"
	strings:
		$s0 = "C:\\tmp\\dump_"
		$s1 = "RST MySQL"
		$s2 = "http://rst.void.ru"
...
rule wh_bindshell_py {
	meta:
		...
		uuid = "b7acbfe7-fd28-5832-9af2-1c5befe4bbab"
	strings:
...
rule lurm_safemod_on_cgi {
	meta:
		...
		uuid = "74e77260-a547-5553-8430-2620f8549f50"
	strings:
...
rule c99madshell_v2_0_php_php {
	meta:
		...
		uuid = "b0724920-dc1e-5819-a99b-618a9a7e1eca"
	strings:
...
rule uploader_php_php {
	meta:
		...
		uuid = "62aa783b-f12f-5bb5-9d96-7aee1666788b"
	strings:
...
rule telnet_pl {
	meta:
		...
		uuid = "be4de017-e929-5dd3-a60e-f187456b1a55"
	strings:
...
rule w3d_php_php {
	meta:
		...
		uuid = "1a4e3c84-2d3b-5245-bccc-9a5f59b9fc17"
	strings:
		$s0 = "W3D Shell"
		$s1 = "By: Warpboy"
...
rule WebShell_cgi {
	meta:
		...
		uuid = "b768bb72-64e8-545a-9123-3d5889b58a82"
	strings:
		$s0 = "WebShell.cgi"
...
rule WinX_Shell_html {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "17ab5086aef89d4951fe9b7c7a561dda"
		uuid = "fe02d995-4375-5ce9-aabe-fae5d29278d3"
	strings:
		$s0 = "WinX Shell"
...
rule Dx_php_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "9cfe372d49fe8bf2fac8e1c534153d9b"
		uuid = "67d0bccb-d39a-5e30-bdc0-801525ebddd7"
	strings:
		$s0 = "print \"\\n\".'Tip: to view the file \"as is\" - open the page in <a href=\"'.Dx"
...
rule csh_php_php {
	meta:
		...
		uuid = "da691516-d6c9-5c4b-85c3-f1cd7fc96ae7"
	strings:
		$s0 = ".::[c0derz]::. web-shell"
...
rule pHpINJ_php_php {
	meta:
		...
		uuid = "7bf54ef4-a3d8-51c6-8db7-bf8947e992ed"
	strings:
...
rule sig_2008_php_php {
	meta:
		...
		uuid = "bfa3caa9-70a5-536b-a887-58427eee43df"
	strings:
...
rule ak74shell_php_php {
	meta:
		...
		uuid = "eaf243cb-fa26-5f34-a724-60a08acff636"
	strings:
...
rule Rem_View_php_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "29420106d9a81553ef0d1ca72b9934d9"
		uuid = "6137434c-89e9-537b-9b26-b56178022b76"
	strings:
...
rule Java_Shell_js {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "36403bc776eb12e8b7cc0eb47c8aac83"
		uuid = "eff52c3a-fc3a-5e80-8da9-786168159ebc"
	strings:
...
rule STNC_php_php {
	meta:
		...
		uuid = "8a7167f6-fa62-574f-a37c-3ceadc7f92ec"
	strings:
...
rule aZRaiLPhp_v1_0_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "26b2d3943395682e36da06ed493a3715"
		uuid = "60152b96-e8d3-5b06-a855-fb64a490742b"
	strings:
		$s0 = "azrailphp"
...
rule Moroccan_Spamers_Ma_EditioN_By_GhOsT_php {
	meta:
		...
		uuid = "721d6e9f-a237-5462-a8d3-f838d7fda420"
	strings:
...
rule zacosmall_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "5295ee8dc2f5fd416be442548d68f7a6"
		uuid = "25946aa7-7c56-5670-ae2f-c55e65a3b911"
	strings:
...
rule CmdAsp_asp {
	meta:
		...
		uuid = "79e0ba85-ed4b-5909-a2fd-9b4125598078"
	strings:
		$s0 = "CmdAsp.asp"
		$s1 = "Set oFileSys = Server.CreateObject(\"Scripting.FileSystemObject\")" fullword
...
rule simple_backdoor_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "f091d1b9274c881f8e41b2f96e6b9936"
		uuid = "5607f501-a750-59be-9595-5ac71ea6f74b"
	strings:
		$s0 = "$cmd = ($_REQUEST['cmd']);" fullword
...
rule mysql_shell_php {
	meta:
		...
		uuid = "e517984b-575c-5ead-a438-9767d2c74099"
	strings:
		$s0 = "SooMin Kim"
...
rule Dive_Shell_1_0___Emperor_Hacking_Team_php {
	meta:
		...
		uuid = "d75294a4-a0a7-5c74-bb7a-766db477633c"
	strings:
...
rule Asmodeus_v0_1_pl {
	meta:
		...
		uuid = "cfd082a8-56fa-54bc-a683-c0052f78e12e"
	strings:
...
rule Reader_asp {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "ad1a362e0a24c4475335e3e891a01731"
		uuid = "70094d24-fa3a-503c-b9b6-294a883fc52c"
	strings:
		$s1 = "Mehdi & HolyDemon"
		$s2 = "www.infilak."
...
rule phpshell17_php {
	meta:
		...
		uuid = "ea1f657c-2023-50bb-a2ee-33c53ee8fb5e"
	strings:
...
rule SimShell_1_0___Simorgh_Security_MGZ_php {
	meta:
		...
		uuid = "51565555-a17b-59c7-b433-c3166fe0d7f0"
	strings:
...
rule jspshall_jsp {
	meta:
		...
		uuid = "4bccad33-d26e-52c2-b7f8-802f2c8f3889"
	strings:
		$s0 = "kj021320"
...
rule rootshell_php {
	meta:
		...
		uuid = "aec6621e-f23a-5f9f-91f1-d2f1b1ab58d0"
	strings:
		$s0 = "shells.dl.am"
...
rule connectback2_pl {
	meta:
		...
		uuid = "4ddebc62-17d2-577e-84bd-207367078327"
	strings:
...
rule DefaceKeeper_0_2_php {
	meta:
		...
		uuid = "671323e2-42cb-5ce0-9839-5d01c446471c"
	strings:
...
rule shells_PHP_wso {
	meta:
		...
		uuid = "fdce6094-a88e-5da6-aeb0-bc97b15bf397"
	strings:
...
rule backdoor1_php {
	meta:
		...
		uuid = "89f44a1c-8a42-58f6-9308-371f4e652bff"
	strings:
...
rule elmaliseker_asp {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "b32d1730d23a660fd6aa8e60c3dc549f"
		uuid = "7ecf3d5c-be91-579e-905b-5f2ad03a0e42"
	strings:
...
rule indexer_asp {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "9ea82afb8c7070817d4cdf686abe0300"
		uuid = "84ff60f9-36f7-5d29-9f38-8088fb42582e"
	strings:
...
rule DxShell_php_php {
	meta:
		...
		uuid = "b89930b7-acf3-5078-8429-d59e27e4b00c"
	strings:
		$s0 = "print \"\\n\".'Tip: to view the file \"as is\" - open the page in <a href=\"'.Dx"
...
rule s72_Shell_v1_1_Coding_html {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "c2e8346a5515c81797af36e7e4a3828e"
		uuid = "dfd3b80e-6245-5f74-9d6a-6006218891ac"
	strings:
...
rule kacak_asp {
	meta:
		...
		uuid = "1ae15174-b84a-5826-b768-7afed65196db"
	strings:
		$s0 = "Kacak FSO 1.0"
...
rule PHP_Backdoor_Connect_pl_php {
	meta:
		...
		uuid = "96c9258e-3894-5ee9-b52c-eb7ba7454416"
	strings:
...
rule Antichat_Socks5_Server_php_php {
	meta:
		...
		uuid = "35d0930c-ef07-5fd4-9d7a-c0d685f92339"
	strings:
...
rule Antichat_Shell_v1_3_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "40d0abceba125868be7f3f990f031521"
		uuid = "856cf977-24da-58e0-b6d2-820c92075ecc"
	strings:
		$s0 = "Antichat"
...
rule Safe_Mode_Bypass_PHP_4_4_2_and_PHP_5_1_2_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "49ad9117c96419c35987aaa7e2230f63"
		uuid = "3e81f628-31b4-5c22-943e-62c8cb4c0c4d"
	strings:
...
rule Worse_Linux_Shell_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "8338c8d9eab10bd38a7116eb534b5fa2"
		uuid = "e223e2a9-7c7a-597a-8b90-a63ee11805ea"
	strings:
...
rule cmd_asp_5_1_asp {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "8baa99666bf3734cbdfdd10088e0cd9f"
		uuid = "fc204ab8-892d-5435-a737-a185ca32e938"
	strings:
...
rule pws_php_php {
	meta:
		...
		uuid = "1ec47c33-dbec-50bd-b4b0-8f00b704a816"
	strings:
...
rule PHP_Shell_php_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "a2f8fa4cce578fc9c06f8e674b9e63fd"
		uuid = "6978126c-5414-52d2-b085-6e5589716d93"
	strings:
...
rule Ayyildiz_Tim___AYT__Shell_v_2_1_Biz_html {
	meta:
		...
		uuid = "d50a8669-fd28-59d2-9f00-f4fe2b85dc22"
	strings:
		$s0 = "Ayyildiz"
		$s1 = "TouCh By iJOo"
...
rule EFSO_2_asp {
	meta:
		...
		uuid = "f0566790-b41c-5167-b7ec-19e7d04256d1"
	strings:
		$s0 = "Ejder was HERE"
...
rule lamashell_php {
	meta:
		...
		uuid = "cbbb3377-ef9c-5fd1-a8b8-2b730fb5ef28"
	strings:
...
rule Ajax_PHP_Command_Shell_php {
	meta:
		...
		uuid = "cae2e035-ae7b-589b-b2d9-e709028274c5"
	strings:
...
rule JspWebshell_1_2_jsp {
	meta:
		...
		uuid = "edfe6a3d-7d56-52ad-a376-cec5722e87b7"
	strings:
		$s0 = "JspWebshell"
...
rule Sincap_php_php {
	meta:
		...
		uuid = "8c4dc7b1-94ce-5528-8442-eae05d2c9980"
	strings:
...
rule Test_php_php {
	meta:
		...
		uuid = "58d73264-6507-5560-ad3e-0cc86c2ee291"
	strings:
		$s0 = "$yazi = \"test\" . \"\\r\\n\";" fullword
...
rule Phyton_Shell_py {
	meta:
		...
		uuid = "2f55d60d-94f3-508d-a2d0-5ab59e3fdab3"
	strings:
...
rule mysql_tool_php_php {
	meta:
		...
		uuid = "c67197d1-6e40-5bf2-9e1b-6ada43529435"
	strings:
...
rule Zehir_4_asp {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "7f4e12e159360743ec016273c3b9108c"
		uuid = "ea7df4e1-d4e2-5a58-a014-d12cb9afaf79"
	strings:
...
rule phpbackdoor15_php {
	meta:
		...
		uuid = "a93b881b-3050-5f43-803c-4a571aaaef82"
	strings:
...
rule phpjackal_php {
	meta:
		...
		uuid = "ae46cb97-1ff8-50ba-856f-c38fbb1e5163"
	strings:
...
rule cgi_python_py {
	meta:
		...
		uuid = "75e99d10-3cdf-5f87-9933-4ce5ebe18b09"
	strings:
...
rule ru24_post_sh_php_php {
	meta:
		...
		uuid = "78669d3e-629b-591a-a766-923e37d1fdba"
	strings:
...
rule DTool_Pro_php {
	meta:
		...
		uuid = "c02c522c-8418-5760-869a-52b41785bebc"
	strings:
		$s0 = "r3v3ng4ns\\nDigite"
...
rule telnetd_pl {
	meta:
		...
		uuid = "05b5d247-3133-5902-a2ee-b84fa89c7f32"
	strings:
		$s0 = "0ldW0lf" fullword
...
rule php_include_w_shell_php {
	meta:
		...
		uuid = "ddcf9031-2ec8-5a86-8326-60e4a699f494"
	strings:
...
rule Safe0ver_Shell__Safe_Mod_Bypass_By_Evilc0der_php {
	meta:
		...
		uuid = "25971f62-33ee-5ed6-8d72-118be5bd2deb"
	strings:
...
rule telnet_cgi {
	meta:
		...
		uuid = "4ca3dace-cd80-58e4-a4de-47dcc64dac0e"
	strings:
...
rule ironshell_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "8bfa2eeb8a3ff6afc619258e39fded56"
		uuid = "0d63ad03-4d1d-535f-8afe-3edaf1bf4010"
	strings:
...
rule backdoorfr_php {
	meta:
		...
		uuid = "5ba2b617-a873-5e80-9cfc-c61cc8d605f3"
	strings:
...
rule aspydrv_asp {
	meta:
		...
		score = 60
		uuid = "4420d13e-7015-5083-ba08-b41bf28b00c2"
	strings:
...
rule cmdjsp_jsp {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "b815611cc39f17f05a73444d699341d4"
		uuid = "048478a8-9622-54c7-80ed-e4e223d14500"
	strings:
...
rule h4ntu_shell__powered_by_tsoi_ {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "06ed0b2398f8096f1bebf092d0526137"
		uuid = "186358e6-88a3-5fad-b1ba-a49b2a5dea1c"
	strings:
		$s0 = "h4ntu shell"
...
rule Ajan_asp {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "b6f468252407efc2318639da22b08af0"
		uuid = "6040fd88-b992-5110-8b37-7711ace30b1a"
	strings:
		$s1 = "c:\\downloaded.zip"
...
rule PHANTASMA_php {
	meta:
		...
		uuid = "21ff4cee-9cdc-57d1-9c43-e033fdb47de0"
	strings:
...
rule MySQL_Web_Interface_Version_0_8_php {
	meta:
		...
		author = "Neo23x0 Yara BRG + customization by Stefan -dfate- Molls"
		hash = "36d4f34d0a22080f47bb1cb94107c60f"
		uuid = "90616d2d-082b-5983-a859-62d1c5b8066e"
	strings:
		$s0 = "SooMin Kim"
...
rule simple_cmd_html {
	meta:
		...
		uuid = "30990574-02a0-5eed-8317-847b6be13300"
	strings:
...
rule _1_c2007_php_php_c100_php {
	meta:
		...
		uuid = "00ada6a4-a32a-5184-867d-e10a8c95c41c"
	strings:
...
rule _nst_php_php_img_php_php_nstview_php_php {
	meta:
		...
		uuid = "238242f5-4e57-5edb-8806-ea5e06f1f637"
	strings:
...
rule _network_php_php_xinfo_php_php_nfm_php_php {
	meta:
		...
		uuid = "4fd11db6-902d-5f1a-96c5-9dfcccce7488"
	strings:
...
rule _w_php_php_c99madshell_v2_1_php_php_wacking_php_php_SpecialShell_99_php_php {
	meta:
		...
		uuid = "ee1fd555-f1bc-59a5-998c-f6098de8623e"
	strings:
...
rule _r577_php_php_SnIpEr_SA_Shell_php_r57_php_php_r57_Shell_php_php_spy_php_php_s_php_php {
	meta:
		...
		uuid = "44b53124-c8b6-545b-819f-77fd65e5d61b"
	strings:
...
rule _r577_php_php_spy_php_php_s_php_php {
	meta:
		...
		uuid = "d287136c-534b-51a4-88fc-40ef9f22d910"
	strings:
...
rule _w_php_php_wacking_php_php_SpecialShell_99_php_php {
	meta:
		...
		uuid = "c01ad0e5-1aff-5128-9d0c-5d0967532a4b"
	strings:
...
rule _r577_php_php_r57_Shell_php_php_spy_php_php_s_php_php {
	meta:
		...
		uuid = "7a31b923-15e5-5af4-9ad0-8d261fedf7c4"
	strings:
		$s0 = "echo ws(2).$lb.\" <a"
...
rule _wacking_php_php_1_SpecialShell_99_php_php_c100_php {
	meta:
		...
		uuid = "3dac5550-598a-5a0f-95c3-2e0162a686ee"
	strings:
...
rule _r577_php_php_r57_php_php_r57_Shell_php_php_spy_php_php_s_php_php {
	meta:
		...
		hash3 = "eed14de3907c9aa2550d95550d1a2d5f"
		hash4 = "817671e1bdc85e04cc3440bbd9288800"
		uuid = "093892f6-ff53-5bd1-b7b2-fea21a9258aa"
	strings:
...
rule _w_php_php_wacking_php_php_SsEs_php_php_SpecialShell_99_php_php {
	meta:
		...
		hash2 = "6cd50a14ea0da0df6a246a60c8f6f9c9"
		hash3 = "09609851caa129e40b0d56e90dfc476c"
		uuid = "81480945-b684-50b6-9431-4ab7a786b214"
	strings:
...
rule _GFS_web_shell_ver_3_1_7___PRiV8_php_nshell_php_php_gfs_sh_php_php {
	meta:
		...
		uuid = "4d1dd87b-1ffd-564d-9411-c5d2fc01ae0f"
	strings:
...
rule _antichat_php_php_Fatalshell_php_php_a_gedit_php_php {
	meta:
		...
		uuid = "6bf5640f-0773-5d93-8d27-0844062017c7"
	strings:
...
rule _Crystal_php_nshell_php_php_load_shell_php_php {
	meta:
		...
		uuid = "a92134cd-7f10-589f-bcda-508bc7a20efe"
	strings:
...
rule _nst_php_php_cybershell_php_php_img_php_php_nstview_php_php {
	meta:
		...
		uuid = "cc4dc0e9-dbb1-560b-ae36-23d3e16a407f"
	strings:
...
rule _w_php_php_c99madshell_v2_1_php_php_wacking_php_php_dC3_Security_Crew_Shell_PRiV_php_SpecialShell_99_php_php {
	meta:
		...
		hash4 = "09609851caa129e40b0d56e90dfc476c"
		uuid = "d22c4cc3-842b-5a24-bf4b-a8024b447b9e"
	strings:
...
rule _w_php_php_c99madshell_v2_1_php_php_wacking_php_php_1_SpecialShell_99_php_php {
	meta:
		...
		hash4 = "09609851caa129e40b0d56e90dfc476c"
		uuid = "4915146e-141c-5515-ac5a-61901d42dc40"
	strings:
...
rule _r577_php_php_r57_php_php_spy_php_php_s_php_php {
	meta:
		...
		hash2 = "eed14de3907c9aa2550d95550d1a2d5f"
		hash3 = "817671e1bdc85e04cc3440bbd9288800"
		uuid = "022d2255-50cd-500b-8d91-8e34f3c46fcf"
	strings:
...
rule DarkSecurityTeam_Webshell {
	meta:
		...
		score = 50
		uuid = "78dcd62f-9215-5571-a5ef-5f811ce9672f"
	strings:
...
rule PHP_Cloaked_Webshell_SuperFetchExec {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		score = 50
		uuid = "4611129a-9865-5603-b1ec-7db0058a80d7"
	strings:
...
rule WebShell_RemExp_asp_php {
	meta:
		...
		uuid = "274c8816-2711-5f12-937e-549ec2d57ce1"
	strings:
...
rule WebShell_dC3_Security_Crew_Shell_PRiV {
	meta:
		...
		uuid = "c83bb4ba-6b4e-5a88-925b-b93d08b304e4"
	strings:
...
rule WebShell_simattacker {
	meta:
		...
		uuid = "2408fad8-780f-50de-a309-99d14a1d87b6"
	strings:
...
rule WebShell_DTool_Pro {
	meta:
		...
		uuid = "9f2922d1-b2af-58ae-b194-ecb33577effa"
	strings:
...
rule WebShell_IronShell_4 {
	meta:
		...
		uuid = "06e87e02-372b-5d4e-be52-5515a068665b"
	strings:
...
rule WebShell_indexer_asp_php {
	meta:
		...
		uuid = "d6e17429-1b58-5a1b-846d-f5dbfd74cf3a"
	strings:
...
rule WebShell_toolaspshell {
	meta:
		...
		uuid = "016af030-4991-583c-aab5-a2933ae0eeec"
	strings:
...
rule WebShell_b374k_mini_shell_php_php {
	meta:
		...
		uuid = "d5b0dfa5-46b5-5323-a8e8-b119d8c2c8e5"
	strings:
...
rule WebShell_Sincap_1_0 {
	meta:
		...
		uuid = "38d39739-660f-596d-a297-1f0dfe530797"
	strings:
...
rule WebShell_b374k_php {
	meta:
		...
		uuid = "73eb7d8d-14bb-5bc2-90b2-90b6bd603bd1"
	strings:
...
rule WebShell_SimAttacker___Vrsion_1_0_0___priv8_4_My_friend {
	meta:
		...
		uuid = "3e0bae7d-77a1-5439-bbe7-177bec23cea0"
	strings:
...
rule WebShell_h4ntu_shell__powered_by_tsoi_ {
	meta:
		...
		uuid = "5a12a025-6497-545a-8da0-423ef448e374"
	strings:
...
rule WebShell_reader_asp_php {
	meta:
		...
		uuid = "80ec18e1-6f41-5188-b2d5-f4228c975fa1"
	strings:
...
rule WebShell_Safe_Mode_Bypass_PHP_4_4_2_and_PHP_5_1_2_3 {
	meta:
		...
		uuid = "349cf6ac-92b3-59f7-a6e4-c23e69b454c6"
	strings:
...
rule WebShell_Liz0ziM_Private_Safe_Mode_Command_Execuriton_Bypass_Exploit_2 {
	meta:
		...
		uuid = "b647f529-be81-51ad-b671-84aec410e133"
	strings:
...
rule WebShell_PHP_Backdoor_2 {
	meta:
		...
		uuid = "65e1305b-4fc7-5885-b3df-92846bb57fe3"
	strings:
...
rule WebShell_Worse_Linux_Shell_2 {
	meta:
		...
		uuid = "04ed7464-29d1-54b9-98ff-afc03475b220"
	strings:
...
rule WebShell_ru24_post_sh {
	meta:
		...
		uuid = "86a45d72-c42d-58d5-9969-d3ebfc22853d"
	strings:
...
rule WebShell_hiddens_shell_v1 {
	meta:
		...
		uuid = "7194998e-c84c-5f59-92fe-857ecf7e8e88"
	strings:
...
rule WebShell_c99_madnet {
	meta:
		...
		uuid = "f2b9c3d1-1c55-59cb-a9bf-8b4011f86a3b"
	strings:
...
rule WebShell_c99_locus7s {
	meta:
		...
		uuid = "f92fe5a2-e465-56ed-a77b-b32ea4c2c105"
	strings:
...
rule WebShell_JspWebshell_1_2 {
	meta:
		...
		uuid = "dfd8c88d-4fe2-5786-9d71-65dba525c358"
	strings:
...
rule WebShell_safe0ver {
	meta:
		...
		uuid = "a7fc8c89-f7a1-5958-823a-763dedb3066d"
	strings:
...
rule WebShell_Uploader {
	meta:
		...
		uuid = "c68e15d9-865e-5269-a91c-00619fe76305"
	strings:
...
rule WebShell_cgitelnet {
	meta:
		...
		uuid = "b02d8549-ebfe-522c-9a6d-8657273da3ed"
	strings:
...
rule WebShell_simple_backdoor_2 {
	meta:
		...
		uuid = "faddd38e-d0c6-5299-9983-53351af1ece5"
	strings:
...
rule WebShell_Safe_Mode_Bypass_PHP_4_4_2_and_PHP_5_1_2_2 {
	meta:
		...
		uuid = "a504442f-85f2-55a1-8a07-1e0faccf8bc0"
	strings:
		$s1 = "<option value=\"/etc/passwd\">Get /etc/passwd</option>" fullword
...
rule WebShell_NTDaddy_v1_9 {
	meta:
		...
		uuid = "a175fd28-5dc2-5827-87f0-4117e889e90e"
	strings:
...
rule WebShell_lamashell {
	meta:
		...
		uuid = "60e39eed-baa2-5999-8560-0a0242ce2608"
	strings:
...
rule WebShell_Simple_PHP_backdoor_by_DK {
	meta:
		...
		uuid = "2c424714-1d2c-5b89-b1bc-a201e37a0a5d"
	strings:
		$s0 = "<!-- Simple PHP backdoor by DK (http://michaeldaw.org) -->" fullword
		$s1 = "<!--    http://michaeldaw.org   2006    -->" fullword
		$s2 = "Usage: http://target.com/simple-backdoor.php?cmd=cat+/etc/passwd" fullword
...
rule WebShell_Moroccan_Spamers_Ma_EditioN_By_GhOsT {
	meta:
		...
		uuid = "4fa9ce70-d300-55fe-bf98-636f026317ec"
	strings:
...
rule WebShell_C99madShell_v__2_0_madnet_edition {
	meta:
		...
		uuid = "51db0495-14f3-527e-865b-1405db57ff27"
	strings:
		$s0 = "$md5_pass = \"\"; //If no pass then hash" fullword
		$s1 = "eval(gzinflate(base64_decode('"
...
rule WebShell_CmdAsp_asp_php {
	meta:
		...
		uuid = "184b1731-31a9-5040-aa25-d145e8064758"
	strings:
...
rule WebShell_NCC_Shell {
	meta:
		...
		uuid = "3a2dab3d-faf0-52a5-b114-db402885c618"
	strings:
...
rule WebShell_backupsql {
	meta:
		...
		uuid = "15d6e967-1e53-53b4-a2cf-7786452495d4"
	strings:
...
rule WebShell_AK_74_Security_Team_Web_Shell_Beta_Version {
	meta:
		...
		uuid = "e93a6ac3-080f-53d3-8368-b9feb509a2ea"
	strings:
...
rule WebShell_accept_language {
	meta:
		...
		uuid = "343ed2a4-4bed-5e73-8d05-f9573b0147af"
	strings:
...
rule WebShell_STNC_WebShell_v0_8 {
	meta:
		...
		uuid = "5dc300a2-9965-52e3-a382-b8d327eb7029"
	strings:
...
rule WebShell_dC3_Security_Crew_Shell_PRiV_2 {
	meta:
		...
		uuid = "1d4a95c4-8128-504d-958f-dcc5c68f4975"
	strings:
		$s0 = "@rmdir($_GET['file']) or die (\"[-]Error deleting dir!\");" fullword
...
rule WebShell_qsd_php_backdoor {
	meta:
		...
		uuid = "f8208851-159c-5d0b-91ad-478aeb4fc9fd"
	strings:
...
rule WebShell_Web_shell__c_ShAnKaR {
	meta:
		...
		uuid = "966f5580-21c5-5ecf-b500-bde3d1ba4494"
	strings:
...
rule WebShell_Ayyildiz_Tim___AYT__Shell_v_2_1_Biz {
	meta:
		...
		uuid = "fdd9bae9-80f3-5200-b922-e7d194009af8"
	strings:
...
rule WebShell_Gamma_Web_Shell {
	meta:
		...
		uuid = "43b4fc9f-8897-5553-8846-29d307efa885"
	strings:
...
rule WebShell_JspWebshell_1_2_2 {
	meta:
		...
		uuid = "659f5c7d-0a9c-554d-a0ad-e3bcb8c5a1e9"
	strings:
		$s0 = "System.out.println(\"CreateAndDeleteFolder is error:\"+ex); " fullword
		$s3 = "<%@ page contentType=\"text/html; charset=GBK\" language=\"java\" import=\"java."
...
rule WebShell_g00nshell_v1_3 {
	meta:
		...
		uuid = "61a09576-7e62-5a30-a52c-492b81b96322"
	strings:
...
rule WebShell_WinX_Shell_2 {
	meta:
		...
		uuid = "ebad4f2e-96c3-5cb7-b228-de3a6a39ae55"
	strings:
...
rule WebShell_PHANTASMA {
	meta:
		...
		uuid = "b36a7dbb-7d40-5fca-8409-c8822298005c"
	strings:
...
rule WebShell_php_include_w_shell {
	meta:
		...
		uuid = "a80ca446-6612-51b4-99a7-8a8d8e6ee196"
	strings:
...
rule WebShell_mysql_tool {
	meta:
		...
		uuid = "a22a0a5c-a686-517e-b1f9-279edab0616b"
	strings:
...
rule WebShell_PhpSpy_Ver_2006 {
	meta:
		...
		uuid = "adbb1963-31c8-5540-a679-c75b1101c163"
	strings:
...
rule WebShell_ZyklonShell {
	meta:
		...
		uuid = "4d7ff3e5-4940-52c8-b045-5db1523f70c2"
	strings:
...
rule WebShell_simple_cmd {
	meta:
		...
		uuid = "1fd0c01a-c265-5e30-ab36-e8e93e316fbe"
	strings:
...
rule WebShell_go_shell {
	meta:
		...
		uuid = "63eaf530-050a-5db7-8885-d4a1e86d62de"
	strings:
...
rule WebShell_aZRaiLPhp_v1_0_2 {
	meta:
		...
		uuid = "10546549-e16d-567d-9d88-3d37fe8ff03f"
	strings:
...
rule WebShell_zehir4_asp_php {
	meta:
		...
		uuid = "7a849bc6-fff5-5bb6-aff7-660889fd077b"
	strings:
...
rule WebShell_CasuS_1_5 {
	meta:
		...
		uuid = "cf89d8f8-d498-57fe-98eb-a98350db182f"
	strings:
...
rule WebShell_ftpsearch {
	meta:
		...
		uuid = "9db8f00a-1843-5057-b8c7-a7f7b63e0659"
	strings:
...
rule WebShell__Cyber_Shell_cybershell_Cyber_Shell__v_1_0_ {
	meta:
		...
		uuid = "79146f25-87b9-5216-af88-4e433bb08b90"
	strings:
...
rule WebShell__Ajax_PHP_Command_Shell_Ajax_PHP_Command_Shell_soldierofallah {
	meta:
		...
		uuid = "a158d158-d48d-514c-8b7b-4b6a4a10d021"
	strings:
...
rule WebShell_Generic_PHP_7 {
	meta:
		...
		uuid = "506373d6-31b4-5a14-b009-f2b43028a98b"
	strings:
...
rule WebShell__Small_Web_Shell_by_ZaCo_small_zaco_zacosmall {
	meta:
		...
		uuid = "99dbcea6-7208-5bbe-b200-9ea3074d7855"
	strings:
...
rule WebShell_Generic_PHP_8 {
	meta:
		...
		uuid = "40c6f69f-9963-5e4f-af44-041d47738519"
	strings:
...
rule WebShell__PH_Vayv_PHVayv_PH_Vayv_klasvayv_asp_php {
	meta:
		...
		uuid = "1575591b-3245-5c3d-b2a4-6def89e77032"
	strings:
...
rule WebShell_Generic_PHP_9 {
   meta:
      ...
      uuid = "98927127-08be-57ac-a090-38c7e614dae7"
   strings:
...
rule WebShell_Generic_PHP_1 {
   meta:
      ...
      uuid = "9a87038b-3f78-5b9a-a209-c9026d83363f"
   strings:
...
rule WebShell_Generic_PHP_2 {
	meta:
		...
		uuid = "be335331-34d7-5abc-b29b-eac7a5ec3915"
	strings:
...
rule WebShell__CrystalShell_v_1_erne_stres {
	meta:
		...
		uuid = "4e73e42e-b968-5b68-a00d-d2a8a1f3541c"
	strings:
...
rule WebShell_Generic_PHP_3 {
	meta:
		...
		uuid = "ff7c6534-efcf-565e-bfc0-1eaa2e9d7b7d"
	strings:
...
rule WebShell_Generic_PHP_4 {
	meta:
		...
		uuid = "2932cb85-927e-536b-b8d8-a0ac0d1ef8ec"
	strings:
		$s0 = "if ($filename != \".\" and $filename != \"..\"){" fullword
...
rule WebShell_GFS {
	meta:
		...
		uuid = "bde6cfd8-466f-528a-b1e3-f874aa778010"
	strings:
...
rule WebShell__CrystalShell_v_1_sosyete_stres {
	meta:
		...
		hash2 = "03f88f494654f2ad0361fb63e805b6bbfc0c86de"
		uuid = "774f7f4c-724a-5eb0-b5de-44b389fd593d"
	strings:
...
rule WebShell_Generic_PHP_10 {
	meta:
		...
		uuid = "f52013d6-72ce-544c-a7ef-ae2a2ea87108"
	strings:
...
rule WebShell_Generic_PHP_11 {
	meta:
		...
		uuid = "590c5320-ef85-5522-94fd-4619749f7eb1"
	strings:
...
rule WebShell__findsock_php_findsock_shell_php_reverse_shell {
	meta:
		...
		uuid = "6567c8f1-bd7f-5844-b937-3db2d8eb7408"
	strings:
...
rule WebShell_Generic_PHP_6 {
	meta:
		...
		hash3 = "36d8782d749638fdcaeed540d183dd3c8edc6791"
		hash4 = "03f88f494654f2ad0361fb63e805b6bbfc0c86de"
		uuid = "e61ec617-565a-5b24-82f4-3677ef379a06"
	strings:
...
rule Unpack_Injectt {
	meta:
		...
		uuid = "80dc3086-41a6-5e30-bbf4-463500fe5e33"
	strings:
...
rule HYTop_DevPack_fso {
	meta:
		...
		uuid = "094eeff9-0da0-5a44-a45c-f8ee57861e7a"
	strings:
		$s0 = "<!-- PageFSO Below -->"
...
rule FeliksPack3___PHP_Shells_ssh {
	meta:
		...
		uuid = "0b971065-df16-5092-beff-c55608447f19"
	strings:
...
rule Debug_BDoor {
	meta:
		...
		uuid = "0938efe7-2b6d-5749-af9a-967cca85defb"
	strings:
		$s1 = "\\BDoor\\"
...
rule bin_Client {
	meta:
		...
		uuid = "8564d787-5edc-59b0-b1ef-2f33c8a24f82"
	strings:
...
rule ZXshell2_0_rar_Folder_ZXshell {
	meta:
		...
		uuid = "621ac87e-b1f8-58d7-9328-54af5ca9b605"
	strings:
		$s0 = "WPreviewPagesn"
		$s1 = "DA!OLUTELY N"
	condition:
...
rule RkNTLoad {
	meta:
		...
		uuid = "fd4b1343-5fa9-5ad8-bee1-6b06b93ddfbe"
	strings:
...
rule binder2_binder2 {
	meta:
		...
		uuid = "29269dc0-f2e4-56ec-ad64-0dff00e339b7"
	strings:
...
rule thelast_orice2 {
	meta:
		...
		uuid = "968cef9e-0163-5f4a-91e3-07510f9f4fcd"
	strings:
		$s0 = " $aa = $_GET['aa'];"
		$s1 = "echo $aa;"
	condition:
...
rule FSO_s_sincap {
	meta:
		...
		uuid = "fcee20a3-e71b-5f69-ac67-8660fd270703"
	strings:
...
rule PhpShell {
	meta:
		...
		uuid = "887264d3-5704-5e38-b0a6-44d529258ea2"
	strings:
...
rule HYTop_DevPack_config {
	meta:
		...
		uuid = "da1b8ce1-8b17-53f6-a86b-ad3fe918084e"
	strings:
...
rule sendmail {
	meta:
		...
		uuid = "dd33c2bb-61bf-57b7-82b9-d864097f7a56"
	strings:
		$s3 = "_NextPyC808"
...
rule FSO_s_zehir4 {
	meta:
		...
		uuid = "9f1adcd6-b721-54ef-a20f-c3a353629a40"
	strings:
		$s5 = " byMesaj "
	condition:
		all of them
...
rule hkshell_hkshell {
	meta:
		...
		uuid = "7436cd7c-7027-56dc-bb62-fac0f70c27d8"
	strings:
		$s1 = "PrSessKERNELU"
		$s2 = "Cur3ntV7sion"
		$s3 = "Explorer8"
...
rule iMHaPFtp {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		hash = "12911b73bc6a5d313b494102abcf5c57"
		uuid = "c810c630-ce08-5059-ad49-f65b244f4d19"
	strings:
...
rule Unpack_TBack {
	meta:
		...
		uuid = "b5f93621-e1e9-5aed-b574-471b4c1f9570"
	strings:
		$s5 = "\\final\\new\\lcc\\public.dll"
	condition:
		all of them
...
rule DarkSpy105 {
	meta:
		...
		uuid = "9d519ccf-fe52-5b82-a39d-c9f86c1089e1"
	strings:
...
rule EditServer_EXE {
	meta:
		...
		uuid = "97928144-0112-5288-8f95-acf7a0d56e71"
	strings:
...
rule FSO_s_reader {
	meta:
		...
		uuid = "d596f7f4-5b0d-5f17-94d3-2582ec041eb1"
	strings:
...
rule ASP_CmdAsp {
	meta:
		...
		uuid = "e4b48843-1936-5717-b2b6-add5b4a14d04"
	strings:
...
rule KA_uShell {
	meta:
		...
		uuid = "34e220db-2fb5-59dc-b5e8-d88f844d3977"
	strings:
...
rule PHP_Backdoor_v1 {
	meta:
		...
		uuid = "f47298a9-a47c-5088-ab1f-1bd76bfd0ca8"
	strings:
...
rule svchostdll {
	meta:
		...
		uuid = "b369d702-1f29-56ec-a742-f87d9c42c775"
	strings:
		$s0 = "InstallService"
		$s1 = "RundllInstallA"
		$s2 = "UninstallService"
...
rule HYTop_DevPack_server {
	meta:
		...
		uuid = "0e4fee1b-8a16-5738-9600-fa965f8c84c2"
	strings:
		$s0 = "<!-- PageServer Below -->"
	condition:
		all of them
...
rule vanquish {
	meta:
		...
		uuid = "143e5e46-ffbc-5aee-9f9b-13374a6c3c10"
	strings:
...
rule winshell {
	meta:
		...
		uuid = "24edd03a-df71-5d84-9764-ba7903b68064"
	strings:
...
rule FSO_s_remview {
	meta:
		...
		uuid = "5040ddbc-2e61-50ca-b738-a4ac8feec3f1"
	strings:
...
rule saphpshell {
	meta:
		...
		uuid = "42bcd739-714e-5dbf-a3a1-929f3d16ed6f"
	strings:
...
rule HYTop2006_rar_Folder_2006Z {
	meta:
		...
		uuid = "bda89055-27f5-50b7-86a3-2c75a5f3eadc"
	strings:
...
rule admin_ad {
	meta:
		...
		uuid = "7d87b4f6-3227-53cb-803c-4f9c7327f203"
	strings:
...
rule FSO_s_casus15 {
	meta:
		...
		uuid = "305842e4-26ad-573d-8df3-e32e239e434b"
	strings:
...
rule BIN_Client {
	meta:
		...
		uuid = "515ab1b3-7923-55de-8c19-71ef5d9b4366"
	strings:
...
rule shelltools_g0t_root_uptime {
	meta:
		...
		uuid = "4f649757-9502-5640-bc17-11cad6c779f4"
	strings:
		$s0 = "JDiamondCSlC~"
		$s1 = "CharactQA"
...
rule Simple_PHP_BackDooR {
	meta:
		...
		uuid = "bd7c19b9-e035-5e70-b626-1d210cadc055"
	strings:
...
rule sig_2005Gray {
	meta:
		...
		uuid = "978fb04e-517d-51cf-98ca-5fd6b421365e"
	strings:
...
rule DllInjection {
	meta:
		...
		uuid = "8a57e122-fd00-57f3-94db-736c5bfd76db"
	strings:
		$s0 = "\\BDoor\\DllInjecti"
	condition:
		all of them
...
rule Mithril_v1_45_Mithril {
	meta:
		...
		uuid = "3c160017-0332-532a-bb7f-390a4a34dc4e"
	strings:
		$s2 = "cress.exe"
		$s7 = "\\Debug\\Mithril."
	condition:
...
rule hkshell_hkrmv {
	meta:
		...
		uuid = "986fad12-9198-5e0a-88d6-a9be6963ff8c"
	strings:
		$s5 = "/THUMBPOSITION7"
		$s6 = "\\EvilBlade\\"
	condition:
...
rule WEBSHELL_PHP_1 {
	meta:
		...
		uuid = "d0107af3-e484-54cf-a238-dd1e71efd3f6"
	strings:
...
rule FSO_s_cmd {
	meta:
		...
		uuid = "f7a74f21-aec9-5ee7-a80e-0fe34b977a71"
	strings:
...
rule FeliksPack3___PHP_Shells_phpft {
	meta:
		...
		uuid = "00bc690b-4977-5076-a40a-edd39c37233f"
	strings:
		$s6 = "PHP Files Thief"
...
rule FSO_s_indexer {
	meta:
		...
		uuid = "fba053d7-5413-563f-8c27-0554349500b2"
	strings:
...
rule bdcli100 {
	meta:
		...
		uuid = "c74e8822-9556-5596-a130-c6e0120d7103"
	strings:
...
rule HYTop_DevPack_2005Red {
	meta:
		...
		uuid = "963effd9-f31d-5238-9419-b5dd11822e56"
	strings:
...
rule rdrbs084 {
	meta:
		...
		uuid = "97548273-6894-5c9f-8cca-d966ce770ada"
	strings:
...
rule HYTop_CaseSwitch_2005 {
	meta:
		...
		uuid = "0f2b8e71-1c11-5efe-bee7-146168aec369"
	strings:
...
rule eBayId_index3 {
	meta:
		...
		uuid = "4fc30150-7b44-53c4-888c-faf651495407"
	strings:
...
rule FSO_s_phvayv {
	meta:
		...
		uuid = "07e027a6-01a5-5250-a35e-fbfef1449cfe"
	strings:
...
rule byshell063_ntboot {
	meta:
		...
		uuid = "7d1f39f6-04f1-51ee-b125-c35af8ae4c0c"
	strings:
...
rule FSO_s_casus15_2 {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		hash = "8d155b4239d922367af5d0a1b89533a3"
		uuid = "d3f67fe9-a93f-504a-8b14-a815135d562f"
	strings:
...
rule installer {
	meta:
		...
		uuid = "681d8284-55e5-5316-a0d2-f4f13218df76"
	strings:
...
rule FSO_s_remview_2 {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		hash = "b4a09911a5b23e00b55abe546ded691c"
		uuid = "8e0492e8-d683-5c2d-b1ce-6c8344b874af"
	strings:
		$s0 = "<xmp>$out</"
		$s1 = ".mm(\"Eval PHP code\")."
	condition:
...
rule FeliksPack3___PHP_Shells_r57 {
	meta:
		...
		uuid = "14092413-27a4-5b7d-9023-0b53b3d45a12"
	strings:
		$s1 = "$sql = \"LOAD DATA INFILE \\\"\".$_POST['test3_file']."
	condition:
		all of them
...
rule FSO_s_phvayv_2 {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		hash = "205ecda66c443083403efb1e5c7f7878"
		uuid = "8bd52f9b-a232-566d-90ab-4085933cdc65"
	strings:
...
rule shelltools_g0t_root_resolve {
	meta:
		...
		uuid = "dcdb9952-63fc-57a7-ae17-ffe8ac4271f1"
	strings:
		$s0 = "3^n6B(Ed3"
		$s1 = "^uldn'Vt(x"
		$s2 = "\\= uPKfp"
...
rule FSO_s_RemExp {
	meta:
		...
		uuid = "48a262bf-7f48-5ed9-b043-80e9d563bf21"
	strings:
...
rule FSO_s_tool {
	meta:
		...
		uuid = "ed744aa4-7a35-57d6-89bd-3286a21b50a0"
	strings:
		$s7 = "\"\"%windir%\\\\calc.exe\"\")"
	condition:
		all of them
...
rule FeliksPack3___PHP_Shells_2005 {
	meta:
		...
		uuid = "91d278d5-e9ec-5a28-9a54-4549b4f0cd07"
	strings:
...
rule byloader {
	meta:
		...
		uuid = "24940e4b-06eb-548d-9e14-1a8f9c864bd3"
	strings:
...
rule shelltools_g0t_root_Fport {
	meta:
		...
		uuid = "664e7b19-4d0b-5062-97d2-0eb34869024d"
	strings:
...
rule BackDooR__fr_ {
	meta:
		...
		uuid = "fd0c77e8-18b7-5eb4-8ed4-87ee4c864683"
	strings:
...
rule FSO_s_ntdaddy {
	meta:
		...
		uuid = "b6b655b8-7bce-5fa5-97b7-a020a7e53f4f"
	strings:
...
rule nstview_nstview {
	meta:
		...
		uuid = "00df601c-bddb-5da8-bef4-d2122419b5d0"
	strings:
...
rule HYTop_DevPack_upload {
	meta:
		...
		uuid = "43054993-b0dd-5d2e-9890-db1f47759be5"
	strings:
		$s0 = "<!-- PageUpload Below -->"
	condition:
		all of them
...
rule PasswordReminder {
	meta:
		...
		uuid = "642033ee-4454-5913-8348-4d1579fc0bd8"
	strings:
...
rule Pack_InjectT {
	meta:
		...
		uuid = "3a640c22-0cd4-5ab1-9216-c68625d7d505"
	strings:
...
rule FSO_s_RemExp_2 {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		hash = "b69670ecdbb40012c73686cd22696eeb"
		uuid = "501544d5-fe52-5933-8782-516ffe18f3ff"
	strings:
...
rule FSO_s_c99 {
	meta:
		...
		uuid = "0b176370-a5ab-587a-b0e9-ef4fe5c604bd"
	strings:
...
rule rknt_zip_Folder_RkNT {
	meta:
		...
		uuid = "a58a3b33-8096-535a-b930-2eb71347edb8"
	strings:
		$s0 = "PathStripPathA"
		$s1 = "`cLGet!Addr%"
...
rule dbgntboot {
	meta:
		...
		uuid = "6b9381e6-597d-5e74-a318-9931d20a9d08"
	strings:
...
rule PHP_shell {
	meta:
		...
		uuid = "08dff4db-3b1c-5702-a8c9-efaedf83c4ff"
	strings:
...
rule hxdef100 {
	meta:
		...
		uuid = "fb376c18-02d2-5866-a0e2-ccb5262091dd"
	strings:
...
rule rdrbs100 {
	meta:
		...
		uuid = "369e5ce0-984c-54eb-96d4-fbfb4f932ba6"
	strings:
...
rule Mithril_Mithril {
	meta:
		...
		uuid = "81645f57-7d7e-5b4d-b323-744f2cde4916"
	strings:
...
rule hxdef100_2 {
	meta:
		...
		uuid = "1f079b73-29de-50cf-868c-1639a43e576f"
	strings:
...
rule Release_dllTest {
	meta:
		...
		uuid = "af821252-8409-5572-9014-59e8c5feaacd"
	strings:
		$s0 = ";;;Y;`;d;h;l;p;t;x;|;"
...
rule webadmin {
	meta:
		...
		uuid = "615d87f8-9094-5994-aea1-d7276623fbca"
	strings:
...
rule commands {
	meta:
		...
		uuid = "7cffefc7-4f24-5908-82a4-f11eda398377"
	strings:
...
rule hkdoordll {
	meta:
		...
		uuid = "c4cfb575-89c3-5a72-8bf5-234d4284fe9d"
	strings:
...
rule r57shell_2 {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		hash = "8023394542cddf8aee5dec6072ed02b5"
		uuid = "d3a3fe11-c9e1-523b-88a3-ddc0c1085d04"
	strings:
...
rule Mithril_v1_45_dllTest {
	meta:
		...
		uuid = "2aea84b6-1b51-58cd-b52b-c31b1f75d295"
	strings:
		$s3 = "syspath"
		$s4 = "\\Mithril"
...
rule dbgiis6cli {
	meta:
		...
		uuid = "2bc59a6b-f45c-5e68-a346-ac56e8f2757b"
	strings:
...
rule remview_2003_04_22 {
	meta:
		...
		uuid = "3088ee27-42a3-5140-98de-ab6f87c7748b"
	strings:
...
rule FSO_s_test {
	meta:
		...
		uuid = "b0cc5a2a-c741-50dd-854f-5a43769e8f47"
	strings:
		$s0 = "$yazi = \"test\" . \"\\r\\n\";"
		$s2 = "fwrite ($fp, \"$yazi\");"
	condition:
...
rule Debug_cress {
	meta:
		...
		uuid = "6cf3e43c-bec1-5688-b1d7-8ac48d59153a"
	strings:
		$s0 = "\\Mithril "
		$s4 = "Mithril.exe"
	condition:
...
rule FSO_s_EFSO_2 {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		hash = "a341270f9ebd01320a7490c12cb2e64c"
		uuid = "e88d324c-1dee-5b07-b528-cf760e3ee7a6"
	strings:
...
rule thelast_index3 {
	meta:
		...
		uuid = "41310217-b9a7-5360-80c4-7d0a3969f848"
	strings:
...
rule adjustcr {
	meta:
		...
		uuid = "4b3d9409-60e8-502a-b37b-1e06d57c9b0b"
	strings:
...
rule FeliksPack3___PHP_Shells_xIShell {
	meta:
		...
		uuid = "32a32a9a-8d5f-5b3f-8ff4-560555f0ae1e"
	strings:
...
rule HYTop_AppPack_2005 {
	meta:
		...
		uuid = "67c86d16-a962-5502-8c39-0a6e3dc04031"
	strings:
...
rule xssshell {
	meta:
		...
		uuid = "ef89653c-5814-525a-b04e-4326a80f780c"
	strings:
...
rule FeliksPack3___PHP_Shells_usr {
	meta:
		...
		uuid = "ab1825fe-96aa-5d97-acd6-eac43a12b237"
	strings:
...
rule FSO_s_phpinj {
	meta:
		...
		uuid = "5d84d518-0e18-517f-890b-e296ac265c50"
	strings:
...
rule xssshell_db {
	meta:
		...
		uuid = "94bb2297-95a2-5442-bb16-fb079a29606e"
	strings:
...
rule xssshell_default {
	meta:
		...
		uuid = "1c221572-4cb5-5806-a856-0f857dba230a"
	strings:
...
rule EditServer_2 {
	meta:
		...
		uuid = "bd254bd9-fd23-5807-9347-2a559089b7c5"
	strings:
		$s0 = "@HOTMAIL.COM"
		$s1 = "Press Any Ke"
		$s3 = "glish MenuZ"
...
rule by064cli {
	meta:
		...
		uuid = "9ea88f0c-9275-5567-a4d9-0545de8044d1"
	strings:
...
rule Mithril_dllTest {
	meta:
		...
		uuid = "59a6bfb6-c099-56cd-b40e-3e92ea0eb7d3"
	strings:
...
rule peek_a_boo {
	meta:
		...
		uuid = "f6ca33b5-e37f-5124-a193-a3056c559314"
	strings:
...
rule fmlibraryv3 {
	meta:
		...
		uuid = "9b8ef79d-80bb-5a05-91e6-0f2bc3fd3068"
	strings:
...
rule Debug_dllTest_2 {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		hash = "1b9e518aaa62b15079ff6edb412b21e9"
		uuid = "cf81e3de-513c-584d-bc37-6504e91b170c"
	strings:
...
rule connector {
	meta:
		...
		uuid = "e46026bc-c570-5057-a132-5a459c959a69"
	strings:
...
rule shelltools_g0t_root_HideRun {
	meta:
		...
		uuid = "dd71dbef-5b5d-5976-8b95-0f202a4b4795"
	strings:
...
rule PHP_Shell_v1_7 {
	meta:
		...
		uuid = "7eb69ac3-90bb-5a44-8dcd-e71f5edcf18f"
	strings:
...
rule xssshell_save {
	meta:
		...
		uuid = "f33c7559-e2f7-5223-a0e9-4e1d3bc7f080"
	strings:
...
rule screencap {
	meta:
		...
		uuid = "0c1b71d3-ad54-5230-b1ab-971647e76139"
	strings:
		$s0 = "GetDIBColorTable"
		$s1 = "Screen.bmp"
		$s2 = "CreateDCA"
...
rule FSO_s_phpinj_2 {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		hash = "dd39d17e9baca0363cc1c3664e608929"
		uuid = "db8f835e-eb13-50f3-a60b-7d8ffcaa5eaa"
	strings:
...
rule ZXshell2_0_rar_Folder_zxrecv {
	meta:
		...
		uuid = "9d36541f-dd55-5385-8e2b-598ad78bdf73"
	strings:
		$s0 = "RyFlushBuff"
...
rule FSO_s_ajan {
	meta:
		...
		uuid = "03bf98b9-c8c5-5b9f-b0cd-700c5ed58eac"
	strings:
...
rule FSO_s_zehir4_2 {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		hash = "5b496a61363d304532bcf52ee21f5d55"
		uuid = "7de89d22-0230-508a-ac50-f61730ad9f4e"
	strings:
...
rule FSO_s_indexer_2 {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		hash = "135fc50f85228691b401848caef3be9e"
		uuid = "8ef79a60-fa8c-51ee-bd87-f5467a66099b"
	strings:
...
rule _root_040_zip_Folder_deploy {
	meta:
		...
		uuid = "7e592ab2-8a53-59d5-a45d-971398586479"
	strings:
...
rule by063cli {
	meta:
		...
		uuid = "9b4a4842-e084-53e8-90fb-603ba034b7df"
	strings:
...
rule icyfox007v1_10_rar_Folder_asp {
	meta:
		...
		uuid = "52150b6a-2f60-5e6b-86d1-61bc0aeb4fa8"
	strings:
...
rule byshell063_ntboot_2 {
	meta:
		...
		uuid = "9bcb401d-619b-54b8-be51-f0e3b6eb096c"
	strings:
...
rule u_uay {
	meta:
		...
		uuid = "6a670e19-6e53-5b13-aabf-fe74d48b9113"
	strings:
...
rule bin_wuaus {
	meta:
		...
		uuid = "50b5323b-d8d1-5350-bf93-8dde3d11fd87"
	strings:
...
rule pwreveal {
	meta:
		...
		uuid = "3d79dd13-9012-56e2-b42a-e6b3e204c601"
	strings:
		$s0 = "*<Blank - no es"
		$s3 = "JDiamondCS "
...
rule shelltools_g0t_root_xwhois {
	meta:
		...
		uuid = "8f3b3bb2-5884-584a-8220-b6edbfebc8a3"
	strings:
		$s1 = "rting! "
		$s2 = "aTypCog("
		$s5 = "Diamond"
...
rule vanquish_2 {
	meta:
		...
		uuid = "6736cad6-cba1-5b6f-ae05-e2b980280479"
	strings:
...
rule down_rar_Folder_down {
	meta:
		...
		uuid = "4e0a0e03-4f01-5b58-807c-0934cdda77ab"
	strings:
...
rule cmdShell {
	meta:
		...
		uuid = "be256fc4-8dc5-58e4-9ca2-5a1df936b8dd"
	strings:
...
rule ZXshell2_0_rar_Folder_nc {
	meta:
		...
		uuid = "106209fc-f957-5131-825b-8eb7835625e0"
	strings:
		$s0 = "WSOCK32.dll"
		$s1 = "?bSUNKNOWNV"
		$s7 = "p@gram Jm6h)"
...
rule portlessinst {
	meta:
		...
		uuid = "c641c522-7844-5002-8ae7-4aaf60d1337d"
	strings:
...
rule SetupBDoor {
	meta:
		...
		uuid = "055ff783-fa9f-5037-a3d6-88b58ec1612f"
	strings:
		$s1 = "\\BDoor\\SetupBDoor"
	condition:
		all of them
...
rule phpshell_3 {
	meta:
		...
		uuid = "2f0ddfef-b3b5-592b-a9fb-fae4d825d0af"
	strings:
...
rule BIN_Server {
	meta:
		...
		uuid = "1625b0ee-5f9f-57d8-8333-f175f46d6c59"
	strings:
		$s0 = "configserver"
		$s1 = "GetLogicalDrives"
		$s2 = "WinExec"
...
rule r57shell_3 {
	meta:
		...
		uuid = "4129d77c-2981-587b-a83e-8767dc3a48d8"
	strings:
		$s1 = "<b>\".$_POST['cmd']"
	condition:
		all of them
...
rule HDConfig {
	meta:
		...
		uuid = "6f743137-e85a-5298-b51e-c8792e507d28"
	strings:
...
rule FSO_s_ajan_2 {
	meta:
		...
		author = "Florian Roth (Nextron Systems)"
		hash = "22194f8c44524f80254e1b5aec67b03e"
		uuid = "a66c34ed-0ae2-5e04-bfc4-c82583c5e066"
	strings:
...
meta:
	...
	date = "10.10.2014"
	score = 50
	uuid = "eb37a22b-4e8a-5986-bd47-4ef5b4986f47"
strings:
...
rule JSP_Browser_APT_webshell {
	meta:
		...
		date = "10.10.2014"
		score = 60
		uuid = "06988b5b-ec8b-5a10-b659-3e846057ea51"
	strings:
...
rule JSP_jfigueiredo_APT_webshell {
	meta:
		...
		uuid = "b5080e43-44e2-54fa-b03a-057dc75d14db"
	strings:
...
rule JSP_jfigueiredo_APT_webshell_2 {
	meta:
		...
		uuid = "91575627-78c1-5ca1-8180-cc4004df88e8"
	strings:
...
rule Webshell_Insomnia {
	meta:
		...
		score = 80
		uuid = "62ed3695-9ab8-54d4-a9d2-b6270c56ccfb"
	strings:
...
rule HawkEye_PHP_Panel {
	meta:
		...
		date = "2014/12/14"
		score = 60
		uuid = "1d185345-6684-538f-954a-45d57a618a7a"
	strings:
...
rule SoakSoak_Infected_Wordpress {
	meta:
		...
		date = "2014/12/15"
		score = 60
		uuid = "d147af65-72de-50be-9435-bef47eb4842a"
	strings:
...
rule Pastebin_Webshell {
	meta:
		...
		uuid = "256051ed-da33-52b4-8bfb-ab990648d8fb"
	strings:
...
rule ASPXspy2 {
	meta:
		...
		uuid = "b68e0c98-0136-58d8-a2d6-57abccb1e942"
	strings:
...
rule Webshell_27_9_c66_c99 {
	meta:
		...
		uuid = "4b985ae7-1ae6-5976-9e8d-0d6b5faed75b"
	strings:
...
rule Webshell_acid_AntiSecShell_3 {
	meta:
		...
		uuid = "68d59f1e-ef35-586b-805d-1e6e3548d092"
	strings:
...
rule Webshell_c99_4 {
	meta:
		...
		uuid = "d5035906-df17-5149-92ae-51e6ec05996e"
	strings:
...
rule Webshell_r57shell_2 {
	meta:
		...
		uuid = "f2298430-1eff-5ed2-abee-3b26b36d16b7"
	strings:
...
rule Webshell_27_9_acid_c99_locus7s {
	meta:
		...
		uuid = "f5f33b64-b815-5e32-8d2e-5e455651ec5d"
	strings:
...
rule Webshell_Backdoor_PHP_Agent_r57_mod_bizzz_shell_r57 {
	meta:
		...
		uuid = "00d3159c-f5d2-5b49-9499-3bb938776858"
	strings:
...
rule Webshell_c100 {
	meta:
		...
		hash7 = "ef3a7cd233a880fc61efc3884f127dd8944808babd1203be2400144119b6057f"
		uuid = "aa8317ff-680d-5b60-b8a9-a77ea58f0ed0"
	strings:
...
rule Webshell_AcidPoison {
	meta:
		...
		uuid = "6c201221-ca67-57fb-9bc7-fab4fc1da982"
	strings:
...
rule Webshell_acid_FaTaLisTiCz_Fx_fx_p0isoN_sh3ll_x0rg_byp4ss_256 {
	meta:
		...
		uuid = "80f7d202-adb8-5d9c-b176-576e3b9553c1"
	strings:
...
rule Webshell_Ayyildiz {
	meta:
		...
		uuid = "cc752958-eb6c-5185-b94c-5fcec833924d"
	strings:
...
rule Webshell_zehir {
	meta:
		...
		uuid = "7f8f15a6-1c5b-5c75-b61a-df7b18699f5a"
	strings:
...
rule UploadShell_98038f1efa4203432349badabad76d44337319a6 {
	meta:
		...
		uuid = "f385b091-ce0d-5d5b-8eeb-57e00c8d0210"
	strings:
...
rule DKShell_f0772be3c95802a2d1e7a4a3f5a45dcdef6997f3 {
	meta:
		...
		uuid = "161ceca6-f5e8-5bcf-bc31-2a2169b1a1c7"
	strings:
...
rule Unknown_8af033424f9590a15472a23cc3236e68070b952e {
	meta:
		...
		uuid = "fcf467b6-f49a-52d0-a57f-9f3cf6d0b25b"
	strings:
...
rule DkShell_4000bd83451f0d8501a9dfad60dce39e55ae167d {
	meta:
		...
		uuid = "804f7229-1440-5a2e-91cd-a58a38b22aa9"
	strings:
...
rule WebShell_5786d7d9f4b0df731d79ed927fb5a124195fc901 {
	meta:
		...
		uuid = "7958e5fc-5ac5-58bc-8128-0a778e99a4e4"
	strings:
...
rule webshell_e8eaf8da94012e866e51547cd63bb996379690bf {
	meta:
		...
		uuid = "8fda9b9f-9a72-5123-91d7-0d0aec9e17bc"
	strings:
...
rule Unknown_0f06c5d1b32f4994c3b3abf8bb76d5468f105167 {
	meta:
		...
		uuid = "efd09da2-f232-5a21-99c8-dc2bf00baa73"
	strings:
...
rule WSOShell_0bbebaf46f87718caba581163d4beed56ddf73a7 {
	meta:
		...
		uuid = "92165645-5392-588d-ba2a-5ef6b7499a5a"
	strings:
...
rule WebShell_Generic_1609_A {
	meta:
		...
		uuid = "4b7db4db-8699-5b4d-ab90-ce79f1160984"
	strings:
...
rule Nishang_Webshell {
	meta:
		...
		date = "2016-09-11"
		uuid = "785e6da7-097e-598b-9799-ffe43738d718"
	strings:
...
rule PHP_Webshell_1_Feb17 {
   meta:
      ...
      date = "2017-02-28"
      uuid = "eedf87c9-2dab-530d-b5d8-a4c2ebc87821"
   strings:
      $h1 = "<?php ${\"\\x" ascii
...
rule Webshell_Tiny_JSP_2 {
	meta:
		...
		date = "2015-12-05"
		score = 100
		uuid = "b628c4f9-eb07-592d-834a-5c94e41987da"
	strings:
...
rule Wordpress_Config_Webshell_Preprend {
   meta:
      ...
      date = "2017-06-25"
		score = 65
      uuid = "2a432c53-5dee-5a2e-9ccf-9e5d52713af9"
   strings:
...
rule PAS_Webshell_Encoded {
   meta:
      ...
      date = "2017-07-11"
      score = 80
      uuid = "6cb547ad-7a97-5c3d-83e1-114ea798ddb8"
   strings:
...
rule ALFA_SHELL {
   meta:
      ...
      uuid = "f0be44ec-bff0-5d01-aabd-df7aa05383e3"
   strings:
...
rule Webshell_FOPO_Obfuscation_APT_ON_Nov17_1 {
   meta:
      ...
      uuid = "0122bb03-8ff0-554d-8fee-458f0ddd7664"
   strings:
...
rule WebShell_JexBoss_JSP_1 {
   meta:
      ...
      uuid = "4fe7a20b-dc2b-509b-bcf8-e3bfbbe7431a"
   strings:
      $x1 = "equals(\"jexboss\")"
...
rule WebShell_JexBoss_WAR_1 {
   meta:
      ...
      uuid = "0973f6cf-8a5f-5449-812e-36aa6b9939df"
   strings:
...
rule webshell_tinyasp {
	...
	date = "2019-01-09"
	uuid = "38b1f61b-e506-59b2-9157-d0345431c429"
   strings:
...
rule WEBSHELL_ASPX_Mar21_1 {
   meta:
      ...
      uuid = "52884135-6b86-5e3e-a866-36a812d5a9af"
   strings:
