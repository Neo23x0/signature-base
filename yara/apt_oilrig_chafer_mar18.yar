...
rule Chafer_Mimikatz_Custom  {
   meta:
      ...
      uuid = "80f751c3-d7ca-5ff6-a905-38650e1c4ec5"
   strings:
...
rule Chafer_Exploit_Copyright_2017 {
   meta:
      ...
      uuid = "f78ae4f5-0569-5fc8-ab25-ebe38afd9f3c"
   strings:
...
rule Chafer_Portscanner {
   meta:
      ...
      uuid = "8db934c3-fb0d-5c87-9096-1ee8fb16f9a5"
   strings:
...
rule Oilrig_Myrtille {
   meta:
      ...
      uuid = "e742ab0c-0e21-569e-a100-e5082dc1d372"
   strings:
...
rule Chafer_Packed_Mimikatz {
   meta:
      ...
      uuid = "abd34c6a-7d99-5f52-be8e-a7d634d61255"
   strings:
...
rule Oilrig_PS_CnC {
   meta:
      ...
      uuid = "cbc5689c-37ff-59b6-9e3a-7d8577021f70"
   strings:
