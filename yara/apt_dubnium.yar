...
rule Dubnium_Sample_1 {
	meta:
		...
		uuid = "377ecbaa-9324-562e-a973-0276d44f3feb"
	strings:
...
rule Dubnium_Sample_2 {
	meta:
		...
		uuid = "894dc893-25fc-5fdc-9f69-8085b94e1af1"
	strings:
...
rule Dubnium_Sample_3 {
	meta:
		...
		uuid = "66f66139-88df-5ba9-a3fc-ba4fc98ce3f9"
	strings:
...
rule Dubnium_Sample_5 {
	meta:
		...
		uuid = "09c1aeee-9437-54e9-967f-3c2fcc0736ed"
	strings:
...
rule Dubnium_Sample_6 {
	meta:
		...
		uuid = "43366f1a-784d-515e-a8e9-3e924f2abfd8"
	strings:
...
rule Dubnium_Sample_7 {
	meta:
		...
		uuid = "6712bd5f-6bbc-5ca0-9fc7-b2013b8f8147"
	strings:
...
rule Dubnium_Sample_SSHOpenSSL {
	meta:
		...
		uuid = "d4f2b494-47b6-5b8e-b358-30159dfb977b"
	strings:
