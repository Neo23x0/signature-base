...
rule EQGRP_noclient_3_0_5 {
	meta:
		...
		date = "2016-08-15"
		score = 75
		uuid = "af7472ce-0605-5f50-8180-23438d2196b8"
	strings:
...
rule EQGRP_installdate {
	meta:
		...
		date = "2016-08-15"
		score = 75
		uuid = "029b1213-1206-5b7c-bd72-93239a23fe8a"
	strings:
...
rule EQGRP_teflondoor {
	meta:
		...
		date = "2016-08-15"
		score = 75
		uuid = "188f9ef1-5524-50be-ac62-91cb9726b155"
	strings:
...
rule EQGRP_durablenapkin_solaris_2_0_1 {
	meta:
		...
		date = "2016-08-15"
		score = 75
		uuid = "7b49a26d-9ee3-5aff-93fc-509239daef28"
	strings:
...
rule EQGRP_teflonhandle {
	meta:
		...
		date = "2016-08-15"
		score = 75
		uuid = "4d82cc41-3777-5f8c-9392-aca69e6ed781"
	strings:
...
rule EQGRP_false {
	meta:
		...
		date = "2016-08-15"
		score = 75
		uuid = "3a68790b-38fc-570b-8b19-c5478cdd2842"
	strings:
...
rule EQGRP_dn_1_0_2_1 {
	meta:
		...
		date = "2016-08-15"
		score = 75
		uuid = "24b5fb51-2463-56ef-818a-949b4b3bbf5b"
	strings:
...
rule EQGRP_morel {
	meta:
		...
		uuid = "e741b727-0e41-53d0-832c-df7f4ea7964a"
	strings:
...
rule EQGRP_bc_parser {
	meta:
		...
		uuid = "ed4523de-b126-503a-83bd-aafd8533b0e5"
	strings:
...
rule EQGRP_1212 {
	meta:
		...
		date = "2016-08-15"
		score = 75
		uuid = "428fed4f-df5c-5fc2-ac4b-4dea69ea4f2d"
	strings:
...
rule EQGRP_1212_dehex {
	meta:
		...
		date = "2016-08-15"
		score = 75
		uuid = "2cc375e6-2bff-5623-b86c-a6413f736c42"
	strings:
...
rule install_get_persistent_filenames {
	meta:
		...
		uuid = "cf74b479-4b78-537a-878c-2f3ce004b775"
	strings:
...
rule EQGRP_create_dns_injection {
	meta:
		...
		uuid = "ef358ca6-ebd8-5d08-944b-f1fcd112f1f3"
	strings:
...
rule EQGRP_screamingplow {
	meta:
		...
		uuid = "cb535ef0-e3ea-54cc-9082-3d63cc96d93a"
	strings:
...
rule EQGRP_MixText {
	meta:
		...
		uuid = "99b06100-8a05-5c22-8b7d-ed451d5f4e81"
	strings:
...
rule EQGRP_tunnel_state_reader {
	meta:
		...
		uuid = "e48c9482-eae5-5c34-b7b2-502d0252f4a0"
	strings:
...
rule EQGRP_payload {
	meta:
		...
		uuid = "949cb68b-e384-578c-a906-a4d9234dc668"
	strings:
...
rule EQGRP_eligiblecandidate {
	meta:
		...
		uuid = "e084b051-4aa1-54b2-9f56-69db386b46d6"
	strings:
...
rule EQGRP_BUSURPER_2211_724 {
	meta:
		...
		uuid = "d109210e-14df-5b90-a496-fa8a2454126b"
	strings:
...
rule EQGRP_networkProfiler_orderScans {
	meta:
		...
		uuid = "2d48df0c-f950-5bb6-8d3e-77c2f970eb57"
	strings:
...
rule EQGRP_epicbanana_2_1_0_1 {
	meta:
		...
		uuid = "cc3346bd-0347-5cf3-b946-5c017d68d93e"
	strings:
...
rule EQGRP_sniffer_xml2pcap {
	meta:
		...
		uuid = "c284ac58-923c-5c34-b420-e87797915233"
	strings:
...
rule EQGRP_BananaAid {
	meta:
		...
		uuid = "bdd3ce51-1809-5b2f-9c7e-6c0b056d022b"
	strings:
...
rule EQGRP_bo {
	meta:
		...
		uuid = "6aa71528-3ce6-5597-bb1a-e44cff3856d6"
	strings:
...
rule EQGRP_SecondDate_2211 {
	meta:
		...
		uuid = "00951270-6189-58b6-8b64-422c4ab15ebe"
	strings:
...
rule EQGRP_config_jp1_UA {
	meta:
		...
		uuid = "947e6f90-4eb4-5241-9819-677cee0c15d8"
	strings:
...
rule EQGRP_userscript {
	meta:
		...
		uuid = "c6c1b70e-437f-50e7-9055-b943a1a62e6c"
	strings:
...
rule EQGRP_BBALL_M50FW08_2201 {
	meta:
		...
		uuid = "bced11a2-fac4-58e5-a4a8-1c6d5fe418f9"
	strings:
		$s1 = ".got_loader" fullword ascii
...
rule EQGRP_BUSURPER_3001_724 {
	meta:
		...
		uuid = "006877e9-1e73-5a27-8b3a-bca3513a2035"
	strings:
...
rule EQGRP_workit {
	meta:
		...
		uuid = "b582f990-5bd5-592d-a7c0-475fdfffc38c"
	strings:
...
rule EQGRP_tinyhttp_setup {
	meta:
		...
		uuid = "71dcc48f-f551-5596-9f03-dbbae470a62b"
	strings:
...
rule EQGRP_shellcode {
	meta:
		...
		uuid = "d923c1de-c6eb-511f-ae1f-bf3ac6e0eae8"
	strings:
...
rule EQGRP_EPBA {
	meta:
		...
		uuid = "5159c2f4-20b7-590d-b216-b3468c26e459"
	strings:
...
rule EQGRP_BPIE {
	meta:
		...
		uuid = "a73f0216-3994-5ee6-8a8c-cbcc1279898e"
	strings:
...
rule EQGRP_jetplow_SH {
	meta:
		...
		uuid = "e7780540-29c9-5827-8ac0-a685d9ba8a5f"
	strings:
...
rule EQGRP_BBANJO {
	meta:
		...
		uuid = "81af4769-7007-51f1-9569-bc370618b4ff"
	strings:
...
rule EQGRP_BPATROL_2201 {
	meta:
		...
		uuid = "864a346c-e8aa-5c66-9867-faccb14b8bee"
	strings:
...
rule EQGRP_extrabacon {
	meta:
		...
		uuid = "79b998ef-e548-5038-b8ad-da1abf362e7f"
	strings:
...
rule EQGRP_sploit_py {
	meta:
		...
		uuid = "9f403965-5fb1-55b2-bef6-65c18e08e58f"
	strings:
...
rule EQGRP_uninstallPBD {
	meta:
		...
		uuid = "0153cb2a-a0de-51f9-80c2-22136d56f16d"
	strings:
...
rule EQGRP_BICECREAM {
	meta:
		...
		uuid = "a10819ae-db48-5d30-8e2e-2e4fe33e005b"
	strings:
...
rule EQGRP_create_http_injection {
	meta:
		...
		uuid = "92b6dad0-c7d8-5522-8fc1-fbd0aae00960"
	strings:
...
rule EQGRP_BFLEA_2201 {
	meta:
		...
		uuid = "7dfdc2a2-73d1-5eba-8936-ed14b17495c5"
	strings:
		$s1 = ".got_loader" fullword ascii
		$s2 = "LOADED" fullword ascii
...
rule EQGRP_BpfCreator_RHEL4 {
	meta:
		...
		uuid = "476185f2-b093-5fb9-8604-891e96fe52a9"
	strings:
...
rule EQGRP_StoreFc {
	meta:
		...
		uuid = "48bbf5c9-e884-5126-93a2-d27650409882"
	strings:
...
rule EQGRP_hexdump {
	meta:
		...
		uuid = "32a7d845-2fa3-5d8f-84e1-2c7f8d2ca8c8"
	strings:
...
rule EQGRP_BARPUNCH_BPICKER {
	meta:
		...
		uuid = "7e88ba9d-1f15-533a-b388-a2a027ddb07c"
	strings:
...
rule EQGRP_Implants_Gen6 {
	meta:
		...
		uuid = "1b1c6426-7274-5fd4-9ea2-ef10bda769d4"
	strings:
...
rule EQGRP_Implants_Gen5 {
	meta:
		...
		uuid = "e35748ee-d530-5e73-a74d-5675d05725e9"
	strings:
...
rule EQGRP_pandarock {
	meta:
		...
		uuid = "aa0ee05b-b3e4-576a-8a32-bdc8d98fe636"
	strings:
...
rule EQGRP_BananaUsurper_writeJetPlow {
	meta:
		...
		uuid = "901af182-cbfa-533a-a055-565d95005d62"
	strings:
...
rule EQGRP_Implants_Gen4 {
	meta:
		...
		uuid = "8b2061f0-862d-51de-a7d0-7a36d3e71d61"
	strings:
...
rule EQGRP_Implants_Gen3 {
	meta:
		...
		hash5 = "6059bec5cf297266079d52dbb29ab9b9e0b35ce43f718022b5b5f760c1976ec3"
		hash6 = "d859ce034751cac960825268a157ced7c7001d553b03aec54e6794ff66185e6f"
		uuid = "ec64bb2b-566b-50b6-a518-222afc88d400"
	strings:
...
rule EQGRP_BLIAR_BLIQUER {
	meta:
		...
		hash1 = "05031898f3d52a5e05de119868c0ec7caad3c9f3e9780e12f6f28b02941895a4"
		hash2 = "d9756e3ba272cd4502d88f4520747e9e69d241dee6561f30423840123c1a7939"
		uuid = "6f83bb11-f789-544e-8dca-c2dc2c845331"
	strings:
...
rule EQGRP_Implants_Gen2 {
	meta:
		...
		uuid = "58b0b51d-d1f8-5ee2-a4af-491c49dd0573"
	strings:
...
rule EQGRP_Implants_Gen1 {
	meta:
		...
		uuid = "af0a1a2c-0efb-568f-9e80-baee7398fea2"
	strings:
...
rule EQGRP_eligiblebombshell_generic {
	meta:
		...
		uuid = "7abe53f6-9880-523a-b71f-6e3850047764"
	strings:
...
rule EQGRP_ssh_telnet_29 {
	meta:
		...
		uuid = "cc6edf63-f7ef-579a-82c5-28e5012561e0"
	strings:
...
rule EQGRP_tinyexec {
	meta:
		...
		reference = "Research"
		date = "2016-08-16"
		uuid = "b783bafd-52e2-59e8-98ab-47de3250415e"
	strings:
...
rule EQGRP_callbacks {
	meta:
		...
		reference = "Research"
		date = "2016-08-16"
		uuid = "dd1fbe09-4def-562d-825d-e790dc2c3dd9"
	strings:
...
rule EQGRP_Extrabacon_Output {
	meta:
		...
		reference = "Research"
		date = "2016-08-16"
		uuid = "b2070ed7-e95a-534a-8f27-63c5ca9251b4"
	strings:
...
rule EQGRP_Unique_Strings {
	meta:
		...
		reference = "Research"
		date = "2016-08-16"
		uuid = "08f5f1e3-ce4e-54ef-922f-50446edfcd70"
	strings:
...
rule EQGRP_RC5_RC6_Opcode {
	meta:
		...
		date = "2016-08-17"
		uuid = "b12a1a2c-8d32-5318-a658-6aa1a08c3263"
	strings:
		/*
			mov     esi, [ecx+edx*4-4]
			sub     esi, 61C88647h
...
rule EquationGroup_modifyAudit_Implant {
   meta:
      ...
      uuid = "0321f6c0-2250-5991-a1d9-f0598e13c665"
   strings:
...
rule EquationGroup_modifyAudit_Lp {
   meta:
      ...
      uuid = "9dcfa774-0048-5bd9-ba7d-87bbdff9567a"
   strings:
...
rule EquationGroup_ProcessHide_Lp {
   meta:
      ...
      uuid = "b0842897-f591-5213-9a26-0f8732e6f3b8"
   strings:
...
rule EquationGroup_pwdump_Implant {
   meta:
      ...
      uuid = "55984c20-539e-5e51-b3c4-caa6157c993d"
   strings:
...
rule EquationGroup_EquationDrug_Gen_5 {
   meta:
      ...
      uuid = "a67655eb-5593-5ac7-a6aa-81f235fa3c33"
   strings:
...
rule EquationGroup_PC_Level3_http_flav_dll {
   meta:
      ...
      uuid = "4bc4804b-c6d2-5c94-b451-24bb0f3dba43"
   strings:
      $s1 = "Psxssdll.dll" fullword wide
      $s2 = "Posix Server Dll" fullword wide
...
rule EquationGroup_LSADUMP_Lp {
   meta:
      ...
      uuid = "8068ca41-6365-5c97-82f2-be9ad89628e0"
   strings:
...
rule EquationGroup_EquationDrug_mstcp32 {
   meta:
      ...
      uuid = "bed26a7b-933f-5578-b65c-65179959050d"
   strings:
...
rule EquationGroup_nethide_Lp {
   meta:
      ...
      uuid = "39e96239-2189-5993-90ba-27e47f7bfdea"
   strings:
...
rule EquationGroup_PC_Level4_flav_dll_x64 {
   meta:
      ...
      uuid = "f05dd0b6-106c-5d1d-ba09-4ac3035e7030"
   strings:
...
rule EquationGroup_PC_Level4_flav_exe {
   meta:
      ...
      uuid = "eb93a798-4e7e-52dc-a39b-bfb63a58d250"
   strings:
...
rule EquationGroup_processinfo_Implant {
   meta:
      ...
      uuid = "b110d819-2298-507b-91bb-2787bb11322e"
   strings:
...
rule EquationGroup_EquationDrug_Gen_2 {
   meta:
      ...
      uuid = "662ee1cf-b837-5362-84a8-1af7335d5e1b"
   strings:
...
rule EquationGroup_EquationDrug_ntevt {
   meta:
      ...
      uuid = "36d23adb-dafe-5e99-8976-b146ceca2f9b"
   strings:
...
rule EquationGroup_nethide_Implant {
   meta:
      ...
      uuid = "36559b69-1718-5d9b-8d6f-3db4becba0c4"
   strings:
...
rule EquationGroup_EquationDrug_Gen_4 {
   meta:
      ...
      uuid = "e3fc376b-f7cc-5dfa-bcf4-4991962a4cf9"
   strings:
...
rule EquationGroup_EquationDrug_tdi6 {
   meta:
      ...
      uuid = "c6dbc28a-ec52-5256-afff-ab15ed1b90a6"
   strings:
...
rule EquationGroup_modifyAuthentication_Implant {
   meta:
      ...
      uuid = "990035c5-cd9c-59e0-b244-e2caafd2561f"
   strings:
      $s1 = "LSASS.EXE" fullword wide
...
rule EquationGroup_ntfltmgr {
   meta:
      ...
      uuid = "dd7fd371-a097-5df5-9ffd-89babbadee96"
   strings:
...
rule EquationGroup_DXGHLP16 {
   meta:
      ...
      uuid = "d9e39c22-f606-5d9c-a5e2-e536b8566595"
   strings:
...
rule EquationGroup_EquationDrug_msgkd {
   meta:
      ...
      uuid = "41019119-9bf4-5a45-b74b-f75ab7738821"
   strings:
...
rule EquationGroup_RunAsChild_Lp {
   meta:
      ...
      uuid = "f0623c3f-3a49-5cdf-89ea-2b3273fd8324"
   strings:
...
rule EquationGroup_EquationDrug_Gen_6 {
   meta:
      ...
      uuid = "99b2fab0-1298-5d48-a78b-eb59942ecfca"
   strings:
      $s1 = "Psxssdll.dll" fullword wide
      $s2 = "Posix Server Dll" fullword wide
...
rule EquationGroup_PC_Level3_http_flav_dll_x64 {
   meta:
      ...
      uuid = "93a3d47d-1dac-5621-8e69-d6d23b7628db"
   strings:
      $s1 = "Psxssdll.dll" fullword wide
      $s2 = "Posix Server Dll" fullword wide
...
rule EquationGroup_EquationDrug_Gen_3 {
   meta:
      ...
      uuid = "f664ad78-1820-5434-94cc-94f98b32e654"
   strings:
...
rule EquationGroup_GetAdmin_Lp {
   meta:
      ...
      uuid = "3bbe0553-a5a3-5207-a94e-ad978606d9a4"
   strings:
...
rule EquationGroup_ModifyGroup_Lp {
   meta:
      ...
      uuid = "82c9617a-3d78-525f-a507-76c87aad7c59"
   strings:
...
rule EquationGroup_pwdump_Lp {
   meta:
      ...
      uuid = "6f356f13-9ec1-5dd9-91b2-6a3071398e81"
   strings:
...
rule EquationGroup_EventLogEdit_Implant {
   meta:
      ...
      uuid = "40239dd0-4159-5c10-96b3-4f1e28c92d97"
   strings:
...
rule EquationGroup_PortMap_Lp {
   meta:
      ...
      uuid = "e1851a17-9858-5c93-9993-2da0559e5d2e"
   strings:
      $s1 = "Privilege elevation failed" fullword wide
...
rule EquationGroup_ProcessOptions_Lp {
   meta:
      ...
      uuid = "5ccb9751-fbcc-538c-8d55-dfc495067ce5"
   strings:
...
rule EquationGroup_PassFreely_Lp {
   meta:
      ...
      uuid = "5fb99194-f0df-54aa-9f20-7f8458155e62"
   strings:
...
rule EquationGroup_EquationDrug_Gen_1 {
   meta:
      ...
      uuid = "331d7ba5-e3fa-5ab7-b4de-c7af764be03d"
   strings:
...
rule EquationDrug_MS_Identifier {
	meta:
		...
		date = "2015/03/11"
		uuid = "c934c117-bf5a-5688-acd9-5d6c6aacd6bc"
	strings:
