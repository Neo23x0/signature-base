...
rule WordDoc_PowerShell_URLDownloadToFile {
   meta:
      ...
      uuid = "f76c5f91-f67c-5754-b771-73383aba4d64"
   strings:
...
rule Suspicious_PowerShell_Code_1 : FILE {
   meta:
      ...
      date = "2017-02-22"
      uuid = "ec3c3682-d2de-52b7-bb49-b021ddf7f8ac"
   strings:
...
rule Suspicious_PowerShell_WebDownload_1 : HIGHVOL FILE {
   meta:
      ...
      modified = "2022-07-27"
      nodeepdive = 1
      uuid = "a763fb82-c840-531b-b631-f282bf035020"
   strings:
...
rule PowerShell_in_Word_Doc {
   meta:
      ...
      uuid = "c9d073ff-25c6-5751-92bf-e22ae7cfd5f5"
   strings:
...
rule Susp_PowerShell_Sep17_1 {
   meta:
      ...
      uuid = "6d4b9113-173f-5c12-b440-7f1cef9e6ebb"
   strings:
...
rule Susp_PowerShell_Sep17_2 {
   meta:
      ...
      uuid = "e44d1dfc-0858-5248-a57f-efb5c647f4cc"
   strings:
...
rule WScript_Shell_PowerShell_Combo {
   meta:
      ...
      uuid = "265ec471-d9ed-5cb6-a32b-cfa62fccdf64"
   strings:
...
rule SUSP_PowerShell_String_K32_RemProcess {
   meta:
      ...
      uuid = "ad646e19-b132-5594-bea2-d74e96c06ebb"
   strings:
...
rule PowerShell_JAB_B64 {
   meta:
      ...
      date = "2018-04-02"
      score = 60
      uuid = "c18fa17b-aaa5-5a89-bc25-3cc51b5af103"
   strings:
      $s1 = "('JAB" ascii wide
...
rule SUSP_PS1_FromBase64String_Content_Indicator : FILE {
   meta:
      ...
      date = "2020-01-25"
      uuid = "326c83ff-5d21-508f-b935-03ccdab6efa7"
   strings:
