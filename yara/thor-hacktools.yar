...
rule WindowsCredentialEditor
{
    meta:
      ...
      threat_level = 10
      score = 90
       uuid = "1542c6e4-36b2-5272-85d0-43226869b43e"
    strings:
...
rule HKTL_Amplia_Security_Tool
{
    meta:
      ...
      date = "2013-01-01"
      modified = "2023-02-14"
      uuid = "4ad83f34-561d-53ce-9766-e21700354da7"
    strings:
      $a = "Amplia Security"
      $c = "getlsasrvaddr.exe"
...
rule PwDump
{
   meta:
      ...
      date = "2014-04-24"
      score = 70
      uuid = "e557e548-53e8-5098-93d4-8e899384e67c"
   strings:
...
rule PScan_Portscan_1 {
   meta:
      ...
      author = "F. Roth"
      score = 50
      uuid = "54997776-644b-5a72-b08c-7174b7dc7f66"
   strings:
...
rule HackTool_Samples {
   meta:
      ...
      score = 50
      uuid = "ecacf84a-f66c-5c21-ae4b-fd9bfb5be384"
   strings:
...
rule Fierce2
{
   meta:
      ...
      date = "01.07.2014"
      score = 60
      uuid = "08a72151-48c2-513b-995f-be0d5acba7dd"
   strings:
...
rule Ncrack
{
   meta:
      ...
      date = "01.07.2014"
      score = 60
      uuid = "c1c56ee9-7f76-5440-b0e0-86e372c53340"
   strings:
...
rule SQLMap
{
   meta:
      ...
      date = "01.07.2014"
      score = 60
      uuid = "55a72fe6-f82d-5d55-842f-5d7e1cfcc9fa"
   strings:
...
rule HKTL_PortScanner_Simple_Jan14 {
   meta:
      ...
      uuid = "3e8960ce-0428-51e1-b992-4fa09fee8520"
   strings:
      $s0 = "Scan Ports Every"
...
rule DomainScanV1_0 {
   meta:
      ...
      uuid = "94ead827-8b29-5cb5-82b6-a7ca5087bf7e"
   strings:
      $s0 = "dIJMuX$aO-EV"
      $s1 = "XELUxP\"-\\"
      $s2 = "KaR\"U'}-M,."
...
rule HKTL_MooreR_Port_Scanner {
   meta:
      ...
      uuid = "5d8fb83f-bed3-53d2-bd33-2158911dc7c8"
   strings:
      $s0 = "Description|"
...
rule NetBIOS_Name_Scanner {
   meta:
      ...
      uuid = "03716e00-a969-5ab5-9be7-e8fc4272e40f"
   strings:
      $s0 = "IconEx"
      $s2 = "soft Visual Stu"
      $s4 = "NBTScanner!y&"
...
rule FeliksPack3___Scanners_ipscan {
   meta:
      ...
      uuid = "8360b268-3434-5142-9248-40b7a1589be9"
   strings:
      $s2 = "WCAP;}ECTED"
      $s4 = "NotSupported"
      $s6 = "SCAN.VERSION{_"
...
rule CGISscan_CGIScan {
   meta:
      ...
      uuid = "60bd5038-a308-55fd-85bb-2c4183f1c951"
   strings:
...
rule IP_Stealing_Utilities {
   meta:
      ...
      uuid = "3a947e9c-d707-5819-88f2-059585750048"
   strings:
      $s0 = "DarkKnight"
...
rule SuperScan4 {
   meta:
      ...
      uuid = "bd353382-ffa2-56c5-b842-1ffc94d6849e"
   strings:
      $s2 = " td class=\"summO1\">"
      $s6 = "REM'EBAqRISE"
...
rule PortRacer {
   meta:
      ...
      uuid = "54717938-2f4c-5442-b0ad-40b9acd1101a"
   strings:
...
rule scanarator {
   meta:
      ...
      uuid = "dfc3ff29-03b4-58ca-bfe0-c6888fddab67"
   strings:
...
rule aolipsniffer {
   meta:
      ...
      uuid = "f7cc0f31-6ba4-504b-82de-0334257b8a95"
   strings:
...
rule _Bitchin_Threads_ {
   meta:
      ...
      uuid = "3a51e76c-b360-5f10-961c-ecc3ea3fa3c9"
   strings:
      $s0 = "DarKPaiN"
      $s1 = "=BITCHIN THREADS"
   condition:
...
rule cgis4_cgis4 {
   meta:
      ...
      uuid = "98fbf445-b7a5-58fa-8f06-34be7321e2eb"
   strings:
      $s0 = ")PuMB_syJ"
      $s1 = "&,fARW>yR"
      $s2 = "m3hm3t_rullaz"
...
rule portscan {
   meta:
      ...
      uuid = "967d6e3b-ae0d-5f93-a20d-742fc010608d"
   strings:
...
rule ProPort_zip_Folder_ProPort {
   meta:
      ...
      uuid = "cd611f6c-42ed-5cd3-a6ab-7e0970925e61"
   strings:
      $s0 = "Corrupt Data!"
      $s1 = "K4p~omkIz"
      $s2 = "DllTrojanScan"
...
rule StealthWasp_s_Basic_PortScanner_v1_2 {
   meta:
      ...
      uuid = "7f706186-f2e2-5d4d-951a-2ec8fc757cec"
   strings:
...
rule BluesPortScan {
   meta:
      ...
      uuid = "4bcb8b7c-5e22-5496-9a29-66e85e3c3395"
   strings:
...
rule scanarator_iis {
   meta:
      ...
      uuid = "a467147b-53c8-53db-aa33-5f0e4e066988"
   strings:
...
rule stealth_Stealth {
   meta:
      ...
      uuid = "5f45882e-3e27-596d-8725-fad380e1c297"
   strings:
...
rule Angry_IP_Scanner_v2_08_ipscan {
   meta:
      ...
      uuid = "5fbcbb95-6cd4-5587-bf44-5b5ed133ce5e"
   strings:
      $s0 = "_H/EnumDisplay/"
      $s5 = "ECTED.MSVCRT0x"
      $s8 = "NotSupported7"
...
rule crack_Loader {
   meta:
      ...
      uuid = "0c4c7b69-7739-5c1b-8c7c-4aaa724e4455"
   strings:
      $s0 = "NeoWait.exe"
      $s1 = "RRRRRRRW"
   condition:
...
rule CN_GUI_Scanner {
   meta:
      ...
      score = 65
      date = "04.10.2014"
      uuid = "ca88d4d3-5d18-5856-874f-e50deceef54f"
   strings:
...
rule CN_Packed_Scanner {
   meta:
      ...
      score = 40
      date = "06.10.2014"
      uuid = "a11c4ee6-7244-5601-af26-a45f9fdc8e1b"
   strings:
...
rule Tiny_Network_Tool_Generic : FILE {
   meta:
      ...
      uuid = "04b1c2c6-605c-52d5-aa07-f3b77a6c4593"
   strings:
...
rule Beastdoor_Backdoor {
   meta:
      ...
      uuid = "64f67233-6677-53c8-b212-f1a425f78803"
   strings:
...
rule Powershell_Netcat {
   meta:
      ...
      score = 60
      date = "10.10.2014"
      uuid = "e4b018c0-3214-5102-93b1-6a048324f9dd"
   strings:
...
rule Chinese_Hacktool_1014 {
   meta:
      ...
      uuid = "e5db5f58-a1fd-51e0-9037-337fcca71f11"
   strings:
...
rule CN_Hacktool_BAT_PortsOpen {
   meta:
      ...
      score = 60
      date = "12.10.2014"
      uuid = "55c3f678-ba70-5a4a-b288-9d0953eff968"
   strings:
...
rule CN_Hacktool_SSPort_Portscanner {
   meta:
      ...
      score = 70
      date = "12.10.2014"
      uuid = "38cc8830-efd3-51b7-8ac6-c9bf468212cb"
   strings:
...
rule CN_Hacktool_ScanPort_Portscanner {
   meta:
      ...
      score = 70
      date = "12.10.2014"
      uuid = "a708283e-339c-599f-9321-3b063d0076a9"
   strings:
...
rule CN_Hacktool_S_EXE_Portscanner {
   meta:
      ...
      score = 70
      date = "12.10.2014"
      uuid = "d6b35d4f-7e25-50dd-bef2-08f7033312e8"
   strings:
      $s0 = "\\Result.txt" ascii
...
rule CN_Hacktool_MilkT_BAT {
   meta:
      ...
      score = 70
      date = "12.10.2014"
      uuid = "d680a5f1-6182-5bc8-99de-c3cba1a61903"
   strings:
...
rule CN_Hacktool_MilkT_Scanner {
   meta:
      ...
      score = 60
      date = "12.10.2014"
      uuid = "aa83c983-25c2-5051-88a1-fbc70d947d6e"
   strings:
...
rule CN_Hacktool_1433_Scanner {
   meta:
      ...
      score = 40
      date = "12.10.2014"
      uuid = "77712d29-1a32-59e7-999a-a2ef02212886"
   strings:
...
rule CN_Hacktool_1433_Scanner_Comp2 {
   meta:
      ...
      score = 40
      date = "12.10.2014"
      uuid = "7d707be5-dad0-5d91-965b-908a8603b6c0"
   strings:
      $s0 = "1433" wide fullword
      $s1 = "1433V" wide
...
rule WCE_Modified_1_1014 {
   meta:
      ...
      score = 70
      uuid = "536d1a7f-bda1-5c22-bf72-a177468e7c42"
   strings:
...
rule ReactOS_cmd_valid {
   meta:
      ...
      uuid = "47df12b4-d202-5520-9c7f-9d0196bc2267"
   strings:
...
rule iKAT_wmi_rundll {
   meta:
      ...
      uuid = "e3d80c95-d333-53cf-8165-b3a1e66ed00d"
   strings:
...
rule iKAT_revelations {
   meta:
      ...
      uuid = "c5ef2c2a-c9c0-5c3a-bbcc-0b0949527850"
   strings:
...
rule iKAT_priv_esc_tasksch {
   meta:
      ...
      uuid = "0786b313-3154-536b-b7eb-c4d8444a309f"
   strings:
...
rule iKAT_command_lines_agent {
   meta:
      ...
      uuid = "35068d59-272d-55a6-b211-2c138276914c"
   strings:
...
rule iKAT_cmd_as_dll {
   meta:
      ...
      uuid = "8d15b4b6-25f3-556c-bfa8-eba503c9c649"
   strings:
...
rule iKAT_tools_nmap {
   meta:
      ...
      uuid = "be4858e6-a8f3-55eb-9c04-f4def838dde1"
   strings:
...
rule iKAT_startbar {
   meta:
      ...
      uuid = "f29f15e9-aa29-519a-b4ad-c018aac68fd6"
   strings:
...
rule iKAT_Tool_Generic {
   meta:
      ...
      uuid = "a8064a26-09c0-59f1-bdf9-628a445014ff"
   strings:
...
rule BypassUac2 {
   meta:
      ...
      uuid = "8b7e49de-9b0a-5dc4-86af-1a854dc649cc"
   strings:
...
rule BypassUac_3 {
   meta:
      ...
      uuid = "407a8e12-1160-584d-94c8-7aa78e29c754"
   strings:
...
rule BypassUac_9 {
   meta:
      ...
      uuid = "a5751d7d-d135-51bc-8351-40374a2d57bf"
   strings:
...
rule BypassUacDll_6 {
   meta:
      ...
      uuid = "5be27053-446f-5ea3-a242-2661aeffa3df"
   strings:
...
rule BypassUac_EXE {
   meta:
      ...
      author = "yarGen Yara Rule Generator"
      hash = "58d7b24b6870cb7f1ec4807d2f77dd984077e531"
      uuid = "b88aded5-7dfb-5cdf-bb42-cd8b069259e0"
   strings:
      $s1 = "Wole32.dll" wide
...
rule APT_Proxy_Malware_Packed_dev
{
   meta:
      ...
      score = 50
      uuid = "0b81b6c9-86fa-59c1-b58c-80310f6c0680"
   strings:
...
rule Tzddos_DDoS_Tool_CN {
   meta:
      ...
      uuid = "bf2bfc7b-4db8-5d35-a312-2530a42985d5"
   strings:
...
rule Ncat_Hacktools_CN {
   meta:
      ...
      uuid = "bdbfaf75-f8c0-508e-b6b1-9ddea179a325"
   strings:
...
rule MS08_067_Exploit_Hacktools_CN {
   meta:
      ...
      uuid = "c15836c7-e739-5cc0-9d41-d651ea3e4738"
   strings:
...
rule Hacktools_CN_Burst_sql {
   meta:
      ...
      uuid = "77ea95fc-7a6a-522b-8a72-1832598c4d2d"
   strings:
...
rule Hacktools_CN_Panda_445TOOL {
   meta:
      ...
      uuid = "02075631-49cc-5b97-ad8e-92d734a26d34"
   strings:
...
rule Hacktools_CN_WinEggDrop {
   meta:
      ...
      uuid = "9b6244ee-5ace-5caa-bfa2-732bcfcfc998"
   strings:
...
rule Hacktools_CN_Scan_BAT {
   meta:
      ...
      uuid = "836e0618-93c7-5519-bbc4-705ff5c2e127"
   strings:
      $s0 = "for /f %%a in (host.txt) do (" ascii
      $s1 = "for /f \"eol=S tokens=1 delims= \" %%i in (s2.txt) do echo %%i>>host.txt" fullword ascii
      $s2 = "del host.txt /q" fullword ascii
...
rule Hacktools_CN_Panda_Burst {
   meta:
      ...
      uuid = "e07c66d1-958e-5ad2-9d5b-380d48af8360"
   strings:
...
rule Hacktools_CN_445_cmd {
   meta:
      ...
      uuid = "b9693f51-26ac-5bf1-8c4d-ca852a154636"
   strings:
...
rule Hacktools_CN_GOGOGO_Bat {
   meta:
      ...
      uuid = "b52cc150-81d4-5895-8f83-ee2006f75617"
   strings:
...
rule Hacktools_CN_Burst_pass {
   meta:
      ...
      uuid = "d8f6784f-80c8-51e2-9d86-40022cd8705d"
   strings:
...
rule Hacktools_CN_JoHor_Posts_Killer {
   meta:
      ...
      uuid = "68bba78e-f3a0-5eaa-9c63-e5f23a76b328"
   strings:
...
rule Hacktools_CN_Panda_tesksd {
   meta:
      ...
      uuid = "399ff307-c2e8-57bb-b792-a2c599e8686e"
   strings:
...
rule Hacktools_CN_Http {
   meta:
      ...
      uuid = "bbff6ff6-8cef-5a83-afd3-34f306e8e715"
   strings:
...
rule Hacktools_CN_Burst_Start {
   meta:
      ...
      uuid = "1291fbc5-fbb3-5425-bb9a-e45f4d7cf562"
   strings:
...
rule Hacktools_CN_Panda_tasksvr {
   meta:
      ...
      uuid = "5c85b382-551a-5e9e-9af8-d106cbe26f74"
   strings:
...
rule Hacktools_CN_Burst_Clear {
   meta:
      ...
      uuid = "21f33a36-779e-5eac-819c-ef79f291b43c"
   strings:
...
rule Hacktools_CN_Burst_Thecard {
   meta:
      ...
      uuid = "a9946aeb-2042-522f-8d91-f8b96341bb64"
   strings:
...
rule Hacktools_CN_Burst_Blast {
   meta:
      ...
      uuid = "9ac723c4-e88d-5fb3-b18f-c8b764c8acf3"
   strings:
...
rule VUBrute_VUBrute {
   meta:
      ...
      uuid = "7ac74c85-465c-5eb5-8e91-004f28cabb75"
   strings:
...
rule DK_Brute {
   meta:
      ...
      uuid = "c9ea0dcf-10f3-5161-aebc-2db04c24b0a5"
   strings:
...
rule VUBrute_config {
   meta:
      ...
      uuid = "25cad108-b2d6-5886-bb2f-e614e05649fa"
   strings:
...
rule sig_238_hunt {
   meta:
      ...
      uuid = "5d9d1f99-2f12-51e9-a554-b349e19d00fb"
   strings:
...
rule sig_238_listip {
   meta:
      ...
      uuid = "417faf20-ee07-5c3e-bfcf-89599e38e62e"
   strings:
...
rule ArtTrayHookDll {
   meta:
      ...
      uuid = "324561fc-024c-5583-aa25-6b13e9616898"
   strings:
...
rule sig_238_eee {
   meta:
      ...
      uuid = "9d3ad3a9-0498-5ca3-ac19-f250cb10c4d3"
   strings:
...
rule aspbackdoor_asp4 {
   meta:
      ...
      uuid = "7718aa71-fc0f-505c-a035-b78ae0438653"
   strings:
...
rule aspfile1 {
   meta:
      ...
      uuid = "1b66dec0-22c8-5937-a0b2-22cbc68241ef"
   strings:
...
rule EditServer {
   meta:
      ...
      uuid = "de6bf995-1c7c-561f-98df-e8748d5fb157"
   strings:
...
rule sig_238_letmein {
   meta:
      ...
      uuid = "5dba055f-1928-534a-8d0e-11dda56d93b7"
   strings:
...
rule sig_238_token {
   meta:
      ...
      uuid = "9d0ac24b-2078-5455-8d9e-a642c71f7b2d"
   strings:
...
rule sig_238_TELNET {
   meta:
      ...
      uuid = "fae22e0f-2f69-5dc6-984c-2c07530ad11a"
   strings:
...
rule snifferport {
   meta:
      ...
      uuid = "5b903344-18d2-5d3d-be66-7260a5f3ea4b"
   strings:
...
rule sig_238_webget {
   meta:
      ...
      uuid = "b03a2463-94fe-5050-8e3d-269101a03cda"
   strings:
...
rule XYZCmd_zip_Folder_XYZCmd {
   meta:
      ...
      uuid = "c3d70b93-1d53-5403-bd22-d1e4bad5042b"
   strings:
...
rule ASPack_Chinese {
   meta:
      ...
      uuid = "ac821117-7534-5dec-9477-25be87361900"
   strings:
...
rule aspbackdoor_EDIR {
   meta:
      ...
      uuid = "0895091a-b620-5746-8245-d44716ec2bbe"
   strings:
...
rule ByPassFireWall_zip_Folder_Ie {
   meta:
      ...
      uuid = "7bd10fa1-be2d-5882-b4c7-b696612343e5"
   strings:
...
rule EditKeyLogReadMe {
   meta:
      ...
      uuid = "db083c04-9e5c-5cfd-b4d4-eecf28191b6b"
   strings:
...
rule PassSniffer_zip_Folder_readme {
   meta:
      ...
      uuid = "f5965aa8-0f78-56fd-8e3e-6dc013942cb3"
   strings:
...
rule sig_238_gina {
   meta:
      ...
      uuid = "85c19493-e6d4-55e8-8526-6817243e90cf"
   strings:
...
rule splitjoin {
   meta:
      ...
      uuid = "2f1a69cd-34b3-5af0-a054-fe19d9becb25"
   strings:
...
rule aspfile2 {
   meta:
      ...
      uuid = "42bbcc16-a6d7-53d7-8651-1a28c6b26ee8"
   strings:
...
rule UnPack_rar_Folder_InjectT {
   meta:
      ...
      uuid = "cc7d1a36-1214-5a14-8589-9eb2339a8700"
   strings:
...
rule Jc_WinEggDrop_Shell {
   meta:
      ...
      uuid = "219df3a1-fe1c-5d33-ab3e-1b3cbd104c9e"
   strings:
...
rule aspbackdoor_asp1 {
   meta:
      ...
      uuid = "fa5128c5-efd5-55dd-880a-2952942e2035"
   strings:
...
rule QQ_zip_Folder_QQ {
   meta:
      ...
      uuid = "30da6292-f670-5b73-985a-3028e20607be"
   strings:
...
rule UnPack_rar_Folder_TBack {
   meta:
      ...
      uuid = "f672f987-0d43-53df-8338-084907b6da16"
   strings:
...
rule sig_238_cmd_2 {
   meta:
      ...
      uuid = "5fae3c4a-aeeb-5e02-9071-3980a39a19a9"
   strings:
...
rule RangeScan {
   meta:
      ...
      uuid = "143d9e1e-41e2-579a-beee-30da2cf068f7"
   strings:
...
rule XYZCmd_zip_Folder_Readme {
   meta:
      ...
      uuid = "cee0f8c3-f947-50a5-ae8c-4ce83ef5e433"
   strings:
...
rule ByPassFireWall_zip_Folder_Inject {
   meta:
      ...
      uuid = "bb31dc53-f3c1-5f8b-84f9-c231a4e1675b"
   strings:
...
rule sig_238_sqlcmd {
   meta:
      ...
      uuid = "0efdfac7-5a89-5251-b583-12b0a58c48ff"
   strings:
...
rule ASPack_ASPACK {
   meta:
      ...
      uuid = "ca9a25f9-a94b-5e10-b935-c6e2d38d999c"
   strings:
...
rule sig_238_2323 {
   meta:
      ...
      uuid = "445f6a49-51e6-5eb8-ae08-e5989aafb6c4"
   strings:
...
rule Jc_ALL_WinEggDropShell_rar_Folder_Install_2 {
   meta:
      ...
      uuid = "ebfc8e53-328c-5deb-bf9b-e0270f171c68"
   strings:
...
rule sig_238_TFTPD32 {
   meta:
      ...
      uuid = "071fba15-affe-539a-bcc0-c14943fff51a"
   strings:
...
rule sig_238_iecv {
   meta:
      ...
      uuid = "08126db3-267b-5289-b562-40bc264f6e3e"
   strings:
...
rule Antiy_Ports_1_21 {
   meta:
      ...
      uuid = "eb53fc91-4dec-5416-a2c7-1e8256297886"
   strings:
...
rule perlcmd_zip_Folder_cmd {
   meta:
      ...
      uuid = "19e4eca0-bd56-57af-afd2-ee2fc5c7c0df"
   strings:
...
rule aspbackdoor_asp3 {
   meta:
      ...
      uuid = "ed86e829-449b-5088-a105-f1fe79547540"
   strings:
...
rule sig_238_FPipe {
   meta:
      ...
      uuid = "0b2f11d9-a919-5790-8724-d2f028e4fa3a"
   strings:
...
rule sig_238_concon {
   meta:
      ...
      uuid = "ca7862cc-1053-5fce-a569-6ecc069314df"
   strings:
...
rule aspbackdoor_regdll {
   meta:
      ...
      uuid = "37096c50-68d0-5412-847a-022062a5ff2a"
   strings:
...
rule CleanIISLog {
   meta:
      ...
      uuid = "439726c6-3262-59ef-9a54-7dcd98cf924d"
   strings:
...
rule sqlcheck {
   meta:
      ...
      uuid = "a72d38ef-b2e7-5051-8538-724d9e95fa6a"
   strings:
...
rule sig_238_RunAsEx {
   meta:
      ...
      uuid = "5fe349db-c0fc-5a49-97ee-3142f4e0e4c1"
   strings:
...
rule sig_238_nbtdump {
   meta:
      ...
      uuid = "fe490f72-a07d-57c2-b9bb-d791fab10ec6"
   strings:
...
rule sig_238_Glass2k {
   meta:
      ...
      uuid = "7a2ad37a-6b55-5710-b07d-7c289cdbb04e"
   strings:
...
rule SplitJoin_V1_3_3_rar_Folder_3 {
   meta:
      ...
      uuid = "4ffd7501-339c-52b7-8661-2c3ca57dfa1f"
   strings:
...
rule aspbackdoor_EDIT {
   meta:
      ...
      uuid = "cdcec370-97af-51c0-b81a-35a788f16ef4"
   strings:
...
rule aspbackdoor_entice {
   meta:
      ...
      uuid = "68c61920-9c3c-5bfe-976c-346b258bb406"
   strings:
...
rule FPipe2_0 {
   meta:
      ...
      uuid = "7e104cf6-69d2-590e-8999-4f0d448719f2"
   strings:
      $s0 = "made to port 80 of the remote machine at 192.168.1.101 with the" fullword ascii
      $s1 = "Unable to resolve hostname \"%s\"" fullword ascii
...
rule InstGina {
   meta:
      ...
      uuid = "ccbda689-e61a-501d-a8ed-62e3c1c20289"
   strings:
...
rule ArtTray_zip_Folder_ArtTray {
   meta:
      ...
      uuid = "d29909a4-8663-54c7-8f0e-68b15def869f"
   strings:
...
rule sig_238_findoor {
   meta:
      ...
      uuid = "61215a76-8c29-505d-bfef-a5f13fec476c"
   strings:
...
rule aspbackdoor_ipclear {
   meta:
      ...
      uuid = "71ebecea-721f-5c5d-9997-6a57f070d91c"
   strings:
...
rule WinEggDropShellFinal_zip_Folder_InjectT {
   meta:
      ...
      uuid = "16f04551-050f-5a07-a35b-a3a7dbba6803"
   strings:
      $s0 = "Packed by exe32pack" ascii
...
rule gina_zip_Folder_gina {
   meta:
      ...
      uuid = "7ebc7218-9c7b-5595-ae7b-f316fc99d1f6"
   strings:
...
rule superscan3_0 {
   meta:
      ...
      uuid = "d22aa3ae-4c62-5007-896d-7c473f0421a6"
   strings:
...
rule sig_238_xsniff {
   meta:
      ...
      uuid = "1e61a732-8691-5f84-beb0-c9f7e6d46538"
   strings:
...
rule sig_238_fscan {
   meta:
      ...
      uuid = "7af4d38a-bc88-57ba-b602-4e01d3d95015"
   strings:
...
rule _iissample_nesscan_twwwscan {
   meta:
      ...
      uuid = "a710ca8e-54dc-5a98-b173-c87b22af745f"
   strings:
...
rule _FsHttp_FsPop_FsSniffer {
   meta:
      ...
      uuid = "5ca543af-2589-52b0-83f9-ad25ba76b633"
   strings:
...
rule Ammyy_Admin_AA_v3 {
   meta:
      ...
      uuid = "bb140cb7-9f56-5acb-883e-080dfd3f60d5"
   strings:
...
rule LinuxHacktool_eyes_scanssh {
   meta:
      ...
      uuid = "9546d0d8-42af-5b4c-ac93-195d14bfbb5b"
   strings:
...
rule LinuxHacktool_eyes_pscan2 {
   meta:
      ...
      uuid = "02d96766-6696-5410-ad48-bd8cb642ac51"
   strings:
...
rule LinuxHacktool_eyes_a {
   meta:
      ...
      uuid = "2b4f52d4-b438-5040-89c5-aab1df15200e"
   strings:
...
rule LinuxHacktool_eyes_mass {
   meta:
      ...
      uuid = "5da0c474-2dc8-5580-bf5c-d3f464225e4c"
   strings:
      $s0 = "cat trueusers.txt | mail -s \"eyes\" clubby@slucia.com" fullword ascii
...
rule LinuxHacktool_eyes_pscan2_2 {
   meta:
      ...
      uuid = "3950b235-70bc-5afd-add5-38c50055b28b"
   strings:
...
rule CN_Portscan : APT
{
    meta:
      ...
      author = "Florian Roth (Nextron Systems)"
        ...
        confidential = false
      score = 70
        uuid = "fb52a89a-2270-5170-9874-9278a0177454"
    strings:
      $s2 = "TCP 12.12.12.12"
    condition:
...
rule WMI_vbs : APT
{
    meta:
      ...
      author = "Florian Roth (Nextron Systems)"
        ...
        confidential = false
      score = 70
        uuid = "b367306a-38d8-5f4d-8f09-2bf025831f0a"
    strings:
      $s3 = "WScript.Echo \"   $$\\      $$\\ $$\\      $$\\ $$$$$$\\ $$$$$$$$\\ $$\\   $$\\ $$$$$$$$\\  $$$$$$"
    condition:
        all of them
...
rule CN_Toolset__XScanLib_XScanLib_XScanLib {
   meta:
      ...
      uuid = "c32415f4-044c-50ef-9c4c-b9327cbcef69"
   strings:
...
rule CN_Toolset_NTscan_PipeCmd {
   meta:
      ...
      uuid = "056ee42d-23f4-5b03-b240-392bc92b90b0"
   strings:
...
rule CN_Toolset_LScanPortss_2 {
   meta:
      ...
      uuid = "0a796585-5fc8-5b55-acfc-3fe87308b681"
   strings:
...
rule CN_Toolset_sig_1433_135_sqlr {
   meta:
      ...
      uuid = "74038975-ef06-53d6-bdcc-02706408b596"
   strings:
...
rule DarkComet_Keylogger_File
{
   meta:
      ...
      date = "25.07.14"
      score = 50
      uuid = "65058450-3ae3-5b85-bcc5-8bc1fab14614"
   strings:
      $entry = /\n:: [A-Z]/
...
rule VSSown_VBS {
   meta:
      ...
      date = "2015-10-01"
      score = 75
      uuid = "ffbb5faf-3522-50dc-a568-503074ac0636"
   strings:
...
rule Netview_Hacktool {
   meta:
      ...
      uuid = "087e2fd7-726e-5c6b-ba99-e20dd3337d6a"
   strings:
...
rule Netview_Hacktool_Output {
   meta:
      ...
      date = "2016-03-07"
      score = 60
      uuid = "259db870-6293-5a55-b56a-f981c060c18f"
   strings:
...
rule PSAttack_EXE {
   meta:
      ...
      uuid = "87f7956a-f607-5e14-a940-5080499cf682"
   strings:
...
rule Powershell_Attack_Scripts {
   meta:
      ...
      date = "2016-03-09"
      score = 70
      uuid = "e8c4a672-229b-56c8-811b-071ae9ff341e"
   strings:
...
rule PSAttack_ZIP {
   meta:
      ...
      uuid = "4e064eb4-0b87-590c-9ee4-6764b982c006"
   strings:
...
rule Linux_Portscan_Shark_1 {
   meta:
      ...
      uuid = "0b264106-3536-56f4-9e8c-68f3756af07d"
   strings:
...
rule Linux_Portscan_Shark_2 {
   meta:
      ...
      uuid = "eea378d5-0399-5035-8573-139878fa1abc"
   strings:
...
rule dnscat2_Hacktool {
   meta:
      ...
      uuid = "23cca0fe-3e4e-5b91-8b53-933de8ff264a"
   strings:
...
rule WCE_in_memory {
   meta:
      ...
      score = 80
      date = "2016-08-28"
      uuid = "90c90ca5-e3be-5035-b35c-c2e7faec43a5"
   strings:
...
rule pstgdump {
   meta:
      ...
      uuid = "86a105a3-b5b5-58b2-99bd-ec05f31adb6b"
   strings:
...
rule lsremora {
   meta:
      ...
      uuid = "c15c583f-70cd-5a80-bdea-a14582097e50"
   strings:
...
rule servpw {
   meta:
      ...
      uuid = "48b9dae1-16b3-563c-ac4e-b71f3a86b38a"
   strings:
...
rule fgexec {
   meta:
      ...
      uuid = "8ffe47b9-81a8-5eb4-b46f-db9d23682de4"
   strings:
...
rule cachedump {
   meta:
      ...
      uuid = "ebcaeb73-d2df-5a4c-9f50-b4a01293b88b"
   strings:
...
rule PwDump_B {
   meta:
      ...
      uuid = "aad974f1-76bf-5aae-8376-a4fd3f27b345"
   strings:
...
rule MSBuild_Mimikatz_Execution_via_XML {
   meta:
      ...
      date = "2016-10-07"
      uuid = "98aa68b9-6de4-5353-8d87-9e974529c044"
   strings:
...
rule Fscan_Portscanner {
   meta:
      ...
      date = "2017-01-06"
      uuid = "400383dc-8bc0-5e77-a3f3-d6ba9f4c3c0f"
   strings:
...
rule WPR_loader_EXE {
   meta:
      ...
      uuid = "97fa3efb-9e7a-52ef-9e26-3fdd573d4d30"
   strings:
...
rule WPR_loader_DLL {
   meta:
      ...
      uuid = "d3102ab6-0473-544b-b9dd-ec7a18ae1c4b"
   strings:
...
rule WPR_Passscape_Loader {
   meta:
      ...
      uuid = "d8e224ce-edd2-5e2d-9b6e-a8995f5d2c1c"
   strings:
...
rule WPR_Asterisk_Hook_Library {
   meta:
      ...
      uuid = "03c20c9d-bb8f-53f6-9cb5-9b059fb24949"
   strings:
...
rule WPR_WindowsPasswordRecovery_EXE {
   meta:
      ...
      uuid = "7fa2062c-75dd-55aa-8775-631a9c1a497e"
   strings:
...
rule WPR_WindowsPasswordRecovery_EXE_64 {
   meta:
      ...
      uuid = "0f6c7695-e616-5757-b9cd-8cff5f972c3e"
   strings:
...
rule BeyondExec_RemoteAccess_Tool {
   meta:
      ...
      uuid = "fd68cb45-a46f-53d7-bf52-8f7bd3636d0d"
   strings:
...
rule Mimikatz_Gen_Strings {
   meta:
      ...
      uuid = "3f4ab5d7-5a9f-55f0-9dda-e2975df582a0"
   strings:
...
rule Disclosed_0day_POCs_lpe {
   meta:
      ...
      uuid = "d3693d1d-6085-5e62-8f0b-dde5b14758b7"
   strings:
...
rule Disclosed_0day_POCs_exploit {
   meta:
      ...
      uuid = "72b8aafd-d79a-5812-90fd-5d5aca109254"
   strings:
...
rule Disclosed_0day_POCs_InjectDll {
   meta:
      ...
      uuid = "90a4dca0-4f12-5946-9d5d-0b93bb5a3c5d"
   strings:
...
rule Disclosed_0day_POCs_payload_MSI {
   meta:
      ...
      uuid = "fe32af56-d5a1-5246-a7df-395b9cd02faf"
   strings:
...
rule Disclosed_0day_POCs_injector {
   meta:
      ...
      uuid = "6de89a84-fe16-5064-8cbb-a3b9003f4c0c"
   strings:
...
rule Disclosed_0day_POCs_lpe_2 {
   meta:
      ...
      uuid = "9326bbae-81ee-588e-8581-628b47d348f8"
   strings:
...
rule Disclosed_0day_POCs_shellcodegenerator {
   meta:
      ...
      uuid = "49250cbe-7bbd-5462-9324-1a8f350386f3"
   strings:
...
rule SecurityXploded_Producer_String {
   meta:
      ...
      uuid = "739c4ba1-5126-51cc-a2dd-cdac2737e29a"
   strings:
...
rule Kekeo_Hacktool {
   meta:
      ...
      uuid = "a4158da8-fc4d-5dc6-b44c-f5325b3bb8ca"
   strings:
...
rule AllTheThings {
   meta:
      ...
      uuid = "c3169ca7-3482-5d55-a1d9-6d1c01349922"
   strings:
...
rule Impacket_Keyword {
   meta:
      ...
      uuid = "a92962e6-1b05-583b-8b06-f226bdea88e2"
   strings:
...
rule PasswordsPro {
   meta:
      ...
      uuid = "c749f883-364e-5f65-9eb8-3dcd74495f7c"
   strings:
...
rule PasswordPro_NTLM_DLL {
   meta:
      ...
      uuid = "cc86b868-000f-56b1-91cd-4aa8caace1df"
   strings:
...
rule KeeThief_PS {
   meta:
      ...
      uuid = "9a54e8d1-3cae-51e8-8da0-024ac25dc6d0"
   strings:
...
rule KeeTheft_EXE {
   meta:
      ...
      uuid = "65531239-c5fa-5285-8f44-2d858e211c9b"
   strings:
...
rule KeeTheft_Out_Shellcode {
   meta:
      ...
      uuid = "1263ad5d-5d50-50e6-ad78-9d5e4e16634b"
   strings:
...
rule Sharpire {
   meta:
      ...
      uuid = "747f2798-4f93-5073-b358-969060a1c937"
   strings:
...
rule Invoke_Metasploit {
   meta:
      ...
      uuid = "40452884-df3f-5b49-ad10-05006cb115f2"
   strings:
...
rule PowerShell_Mal_HackTool_Gen {
   meta:
      ...
      uuid = "d1fc4594-d816-5d02-bff6-3f220477b555"
   strings:
...
rule Sig_RemoteAdmin_1 {
   meta:
      ...
      date = "2017-12-03"
      score = 45
      uuid = "da55084c-ec1f-5800-a614-189dce7b5820"
   strings:
...
rule RemCom_RemoteCommandExecution {
   meta:
      ...
      date = "2017-12-28"
      score = 50
      uuid = "90b4ce3c-a690-5b6e-95e8-7e5dc8270152"
   strings:
      $ = "\\\\.\\pipe\\%s%s%d"
      $ = "%s\\pipe\\%s%s%d%s"
      $ = "\\ADMIN$\\System32\\%s%s"
...
rule Crackmapexec_EXE {
   meta:
      ...
      uuid = "9fcfba98-7ba1-5810-99b7-62ad2b1aa4c0"
   strings:
...
rule SUSP_Imphash_PassRevealer_PY_EXE {
   meta:
      ...
      score = 40
      hash1 = "371f104b7876b9080c519510879235f36edb6668097de475949b84ab72ee9a9a"
      uuid = "9462dfc4-2feb-591d-ac0c-ba02f093c216"
   strings:
...
rule MAL_Unknown_PWDumper_Apr18_3 {
   meta:
      ...
      uuid = "2431d562-dcd8-5d21-8406-7d2567b6eca9"
   strings:
...
rule ProcessInjector_Gen : HIGHVOL {
   meta:
      ...
      uuid = "9b0b6ac7-8432-5f93-b389-c2356ec75113"
   strings:
...
rule Lazagne_PW_Dumper {
   meta:
      ...
      date = "2018-03-22"
      score = 70
      uuid = "1904029e-9336-5278-ae2e-4bc853316600"
   strings:
...
rule HKTL_shellpop_TCLsh {
   meta:
      ...
      uuid = "24f6b626-383e-54c9-abd4-bd67c37af937"
   strings:
...
rule HKTL_shellpop_ruby {
   meta:
      ...
      uuid = "cb3a93d5-02a1-5a49-b37e-3f9312b993ea"
   strings:
...
rule HKTL_shellpop_awk {
   meta:
      ...
      uuid = "92d1e6dd-d758-5df2-b5e5-eb275964551d"
   strings:
...
rule HKTL_shellpop_Netcat_UDP {
   meta:
      ...
      uuid = "67aa53b6-00bc-5d2e-b6f3-37e9121cdd01"
   strings:
...
rule HKTL_shellpop_socat {
   meta:
      ...
      uuid = "23c331ba-217c-5b17-b45e-d553eea76a56"
   strings:
...
rule HKTL_shellpop_Perl {
   meta:
      ...
      uuid = "d597d213-a70b-5412-adde-791b4d498848"
   strings:
...
rule HKTL_shellpop_Python {
   meta:
      ...
      uuid = "62fe0ae9-422e-5021-8a67-e88ff4bd2cf3"
   strings:
...
rule HKTL_shellpop_PHP_TCP {
   meta:
      ...
      uuid = "3bafc225-62e5-5183-84aa-9c3406b6c444"
   strings:
...
rule HKTL_shellpop_Powershell_TCP {
   meta:
      ...
      uuid = "4f3a92db-f686-559a-9588-fb79f423c51f"
   strings:
...
rule SUSP_Powershell_ShellCommand_May18_1 {
   meta:
      ...
      date = "2018-05-18"
      hash1 = "8328806700696ffe8cc37a0b81a67a6e9c86bb416364805b8aceaee5db17333f"
      uuid = "efa81fd0-b764-5a1a-98a5-fc3135be220b"
   strings:
...
rule HKTL_shellpop_Telnet_TCP {
   meta:
      ...
      uuid = "dbd5cc65-c6f1-54f3-813f-7a7f9bcca184"
   strings:
...
rule SUSP_shellpop_Bash {
   meta:
      ...
      uuid = "ea9c2491-8b25-5ba4-9968-22a45d6e6491"
   strings:
...
rule HKTL_shellpop_netcat {
   meta:
      ...
      uuid = "cd55e912-b57b-5fce-98eb-5a0cd27a6e4d"
   strings:
...
rule HKTL_beRootexe {
   meta:
      ...
      uuid = "b91c2e0b-2e47-5339-bf48-eaa8329ea63b"
   strings:
...
rule HKTL_beRootexe_output {
   meta:
      ...
      reference = "https://github.com/AlessandroZ/BeRoot/tree/master/Windows"
      date = "2018-07-25"
      uuid = "dfd11915-443f-5ce9-b94a-bdcb0e62104e"
   strings:
...
rule HKTL_EmbeddedPDF {
   meta:
      ...
      date = "2018-07-25"
      uuid = "d4e2d878-fb75-54c5-9879-fe94102911d1"
   strings:
...
rule HTKL_BlackBone_DriverInjector {
   meta:
      ...
      uuid = "0d992a6c-c57a-5895-af0d-9c167d922601"
   strings:
...
rule HKTL_SqlMap {
   meta:
      ...
      uuid = "da2029dd-c4ce-557f-a409-c468fa3deef3"
   strings:
...
rule HKTL_SqlMap_backdoor {
   meta:
      ...
      reference = "https://github.com/sqlmapproject/sqlmap"
      date = "2018-10-09"
      uuid = "bf09caac-cf15-5936-b5b4-df4f28788961"
   condition:
...
rule HKTL_Lazagne_PasswordDumper_Dec18_1 {
   meta:
      ...
      uuid = "bae48a4d-33b6-55b9-abf5-daf87e5da9e9"
   strings:
...
rule HKTL_Lazagne_Gen_18 {
   meta:
      ...
      uuid = "034ea6d8-f5cf-5664-9ff9-24d19403093d"
   strings:
...
rule HKTL_NoPowerShell {
   meta:
      ...
      uuid = "17d508d5-833f-5232-a071-dbed8758493b"
   strings:
...
rule HKTL_htran_go {
   meta:
      ...
      date = "2019-01-09"
      uuid = "bd9409e3-3d4c-57d6-af60-b6d6bd93d46b"
   strings:
...
rule SUSP_Katz_PDB {
   meta:
      ...
      uuid = "79f4f07c-b234-5203-a2ab-aba4a9cb9f8d"
   strings:
...
rule HKTL_LNX_Pnscan {
   meta:
      ...
      date = "2019-05-27"
      score = 55
      uuid = "46c6c0d9-08bb-5de3-ad14-c1a7ab0542c6"
   strings:
...
rule PAExec {
   meta:
      ...
      uuid = "ee564534-b921-5639-a7ed-5da79d6bf86a"
   strings:
...
rule HKTL_DomainPasswordSpray {
   meta:
      ...
      uuid = "890e4514-2846-54f8-8f32-cc9d2a4ef81b"
   strings:
...
rule HKTL_RustHound {
   meta:
        ...
        uuid = "d2fd79a5-9a1a-51de-920c-61653c8b0064"
   strings:
