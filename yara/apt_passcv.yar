...
rule PassCV_Sabre_Malware_1 {
   meta:
      ...
      uuid = "99a26daa-c563-5b23-89b9-965d8ce7229d"
   strings:
...
rule PassCV_Sabre_Malware_Signing_Cert {
   meta:
      ...
      uuid = "2b2d1313-6454-5e3f-9b58-5b1a26739ba8"
   strings:
...
rule PassCV_Sabre_Malware_2 {
   meta:
      ...
      uuid = "dd9eb5f6-9faa-584d-b3b5-6dcfdc3f359c"
   strings:
...
rule PassCV_Sabre_Malware_Excalibur_1 {
   meta:
      ...
      uuid = "eadad36c-49c8-50e1-8334-813d2e760fe9"
   strings:
...
rule PassCV_Sabre_Malware_3 {
   meta:
      ...
      uuid = "03e5efc0-6076-501f-a600-b3d9008a8711"
   strings:
...
rule PassCV_Sabre_Malware_4 {
   meta:
      ...
      uuid = "f182064d-3a91-5a61-aa0f-2ce491a60126"
   strings:
...
rule PassCV_Sabre_Tool_NTScan {
   meta:
      ...
      uuid = "6ec3371a-2a1c-53d1-b650-d28728db1b40"
   strings:
...
rule PassCV_Sabre_Malware_5 {
   meta:
      ...
      uuid = "ce8d1b9e-7750-5796-a048-20bfd48c6aee"
   strings:
