...
rule Empire_Invoke_MetasploitPayload {
   meta:
      ...
      uuid = "608c30b0-826a-55b1-afb8-756b476d6b55"
   strings:
...
rule Empire_Exploit_Jenkins {
   meta:
      ...
      uuid = "f2162783-34cd-5db4-bd1c-6c58feb92e77"
   strings:
...
rule Empire_Get_SecurityPackages {
   meta:
      ...
      uuid = "a109eda1-a26d-5cf6-b6b5-1a1a1e770a0a"
   strings:
...
rule Empire_Invoke_PowerDump {
   meta:
      ...
      uuid = "d1082a4e-d458-57fb-b332-7c775c8ef2dd"
   strings:
...
rule Empire_Install_SSP {
   meta:
      ...
      uuid = "06bbdcc5-c48b-5753-88a2-5c962d1b986f"
   strings:
...
rule Empire_Invoke_ShellcodeMSIL {
   meta:
      ...
      uuid = "06011b51-bad7-5656-ac37-e49f9b6d0498"
   strings:
...
rule HKTL_Empire_PowerUp {
   meta:
      ...
      uuid = "e79d093e-7481-52a3-a350-4d1b6d8955cd"
   strings:
...
rule Empire_Invoke_Mimikatz_Gen {
   meta:
      ...
      uuid = "1f771a17-2534-5811-80bd-bc1bab37d97c"
   strings:
...
rule Empire_Get_GPPPassword {
   meta:
      ...
      uuid = "7791b009-19d3-5d08-8ef7-4723d28830ed"
   strings:
...
rule Empire_Invoke_SmbScanner {
   meta:
      ...
      uuid = "63cd048b-04fd-5b4f-9d4d-3a001c31b4df"
   strings:
...
rule Empire_Exploit_JBoss {
   meta:
      ...
      uuid = "a9c75cf5-9469-5a45-b750-69728ed0069f"
   strings:
...
rule Empire_dumpCredStore {
   meta:
      ...
      uuid = "cdb87ed4-fa90-5724-b37d-97cf8e4b8326"
   strings:
...
rule Empire_Invoke_EgressCheck {
   meta:
      ...
      uuid = "21e09250-6853-5743-a6ef-aa6be8091d33"
   strings:
...
rule Empire_ReflectivePick_x64_orig {
   meta:
      ...
      uuid = "cd69a149-d881-5f93-9647-84241bd96ba5"
   strings:
...
rule Empire_Out_Minidump {
   meta:
      ...
      uuid = "8c53d2ab-afc5-5d7b-97e1-496425b9664f"
   strings:
...
rule Empire_Invoke_PsExec {
   meta:
      ...
      uuid = "19aaec3e-3e8f-5d7d-9c70-a212756c0300"
   strings:
...
rule Empire_Invoke_PostExfil {
   meta:
      ...
      uuid = "58d9e057-efde-56ab-9b7e-982342a910e2"
   strings:
...
rule Empire_Invoke_SMBAutoBrute {
   meta:
      ...
      uuid = "a6b402ac-0925-5bc6-9d6a-b2b811496f9e"
   strings:
...
rule Empire_Get_Keystrokes {
   meta:
      ...
      uuid = "7fb57a0d-6b65-5ee8-96ef-9af303f15007"
   strings:
...
rule Empire_Invoke_DllInjection {
   meta:
      ...
      uuid = "6aa14e8f-9801-5cd3-beb0-955e19d25503"
   strings:
...
rule Empire_KeePassConfig {
   meta:
      ...
      uuid = "814a6ff9-a6ac-55e7-bb3f-597351ce421d"
   strings:
...
rule Empire_Invoke_SSHCommand {
   meta:
      ...
      uuid = "b06b507f-b6b8-5f4b-8d6d-920f141e9ac1"
   strings:
...
rule Empire_PowerShell_Framework_Gen1 {
   meta:
      ...
      uuid = "8fdb48a0-5d40-55be-ae23-e9c8c4c2ecea"
   strings:
...
rule Empire_PowerUp_Gen {
   meta:
      ...
      super_rule = 1
      hash1 = "ad9a5dff257828ba5f15331d59dd4def3989537b3b6375495d0c08394460268c"
      uuid = "ae6b0462-7193-54a4-8fb9-befc1b461b15"
   strings:
...
rule Empire_PowerShell_Framework_Gen2 {
   meta:
      ...
      uuid = "eab277ca-0dd4-5035-82aa-1ac2120bac94"
   strings:
...
rule Empire_Agent_Gen {
   meta:
      ...
      uuid = "0fac915c-2502-50da-93d1-f81e9282aa9a"
   strings:
...
rule Empire_PowerShell_Framework_Gen3 {
   meta:
      ...
      uuid = "b0f7ed41-be65-5e43-aeb1-56e5e7384e8f"
   strings:
...
rule Empire_Invoke_InveighRelay_Gen {
   meta:
      ...
      uuid = "0adebf6f-99e1-5461-8efc-e4660faf6d5d"
   strings:
...
rule Empire_KeePassConfig_Gen {
   meta:
      ...
      uuid = "e2bc88c5-50f8-5ddc-a449-41929b1d0528"
   strings:
...
rule Empire_Invoke_Portscan_Gen {
   meta:
      ...
      uuid = "c2e01780-02d2-57d1-b38e-5c345ebccad6"
   strings:
...
rule Empire_PowerShell_Framework_Gen4 {
   meta:
      ...
      uuid = "c390638a-0eb1-576d-a08c-203c31d414f3"
   strings:
...
rule Empire_Invoke_CredentialInjection_Invoke_Mimikatz_Gen {
   meta:
      ...
      hash1 = "1be3e3ec0e364db0c00fad2c59c7041e23af4dd59c4cc7dc9dcf46ca507cd6c8"
      hash2 = "4725a57a5f8b717ce316f104e9472e003964f8eae41a67fd8c16b4228e3d00b3"
      uuid = "d938aadf-6924-5964-9b5a-6bd1b817349f"
   strings:
...
rule Empire_Invoke_Gen {
   meta:
      ...
      uuid = "913f971d-e4e3-55e9-904b-82b25a4e6f0f"
   strings:
...
rule Empire_PowerShell_Framework_Gen5 {
   meta:
      ...
      hash2 = "61e5ca9c1e8759a78e2c2764169b425b673b500facaca43a26c69ff7e09f62c4"
      hash3 = "eaff29dd0da4ac258d85ecf8b042d73edb01b4db48c68bded2a8b8418dc688b5"
      uuid = "4c23592e-5788-5b84-995a-028142cbc52f"
   strings:
