...
rule APT_HAFNIUM_ForensicArtefacts_OAB_Temp_dll{
   meta:
      description = "Temporary assembly generated by ASPX Webshell compilation during exchange OAB exploitation. Target path: C:/Windows/Microsoft.NET/*/*/Temporary ASP.NET Files/**/App_Web\\w.{8}\\.dll$"
