...
rule EXPL_Exchange_ProxyShell_Failed_Aug21_1 : SCRIPT {
   meta:
      ...
      date = "2021-08-08"
      modified = "2021-08-09"
      uuid = "9b849042-8918-5322-a35a-2165d4b541d5"
   strings:
...
rule EXPL_Exchange_ProxyShell_Successful_Aug21_1 : SCRIPT {
   meta:
      ...
      date = "2021-08-08"
      modified = "2021-08-09"
      uuid = "8c11cd1a-6d3f-5f29-af61-17179b01ca8b"
   strings:
...
rule WEBSHELL_ASPX_ProxyShell_Aug21_2 {
   meta:
      ...
      date = "2021-08-13"
      uuid = "a351a466-695e-570e-8c7f-9c6c0534839c"
   strings:
...
rule WEBSHELL_ASPX_ProxyShell_Aug21_3 {
   meta:
      ...
      date = "2021-08-23"
      score = 75
      uuid = "a7bca62b-c8f1-5a38-81df-f3d4582a590b"
   strings:
      $s1 = "Page Language=" ascii nocase
   condition:
...
rule WEBSHELL_ASPX_ProxyShell_Sep21_1 { 
   meta:
      ...
      score = 75
      uuid = "d0d23e17-6b6a-51d1-afd9-59cc2404bcd8"
   strings:
...
rule APT_IIS_Config_ProxyShell_Artifacts {
   meta:
      ...
      date = "2021-08-25"
      score = 90
      uuid = "21888fc0-82c6-555a-9320-9cbb8332a843"
   strings:
...
rule WEBSHELL_ASPX_ProxyShell_Exploitation_Aug21_1 {
   meta:
      ...
      date = "2021-08-25"
      score = 90
      uuid = "1fa563fc-c91c-5f4e-98f1-b895e1acb4f4"
   strings:
      $x1 = ");eval/*asf" ascii
   condition:
...
rule WEBSHELL_ASPX_ProxyShell_Aug15 {
   meta:
      ...
      date = "2021-09-04"
      score = 75
      uuid = "b1e6c0f3-787f-59b8-8123-4045522047ca"
   strings:
...
rule WEBSHELL_Mailbox_Export_PST_ProxyShell_Aug26 {
   meta:
      ...
      date = "2021-09-04"
      score = 85
      uuid = "6aea414f-d27c-5202-84f8-b8620782fc90"
   strings:
...
rule SUSP_IIS_Config_ProxyShell_Artifacts {
   meta:
      ...
      date = "2021-08-25"
      score = 70
      uuid = "bde65d9e-b17d-5746-8d29-8419363d0511"
   strings:
      $a1 = "<site name=" ascii /* marker used to select IIS configs */
      $a2 = "<sectionGroup name=\"system.webServer\">" ascii
...
rule SUSP_IIS_Config_VirtualDir {
   meta:
      ...
      modified = "2022-09-17"
      score = 60
      uuid = "cfe5ca5e-a0cc-5f60-84d2-1b0538e999c7"
   strings:
      $a1 = "<site name=" ascii /* marker used to select IIS configs */
      $a2 = "<sectionGroup name=\"system.webServer\">" ascii
...
rule SUSP_ASPX_PossibleDropperArtifact_Aug21 {
   meta:
      ...
      date = "2021-08-23"
      score = 60
      uuid = "52016598-74a1-53d6-812a-40b078ba0bb9"
   strings:
      $s1 = "Page Language=" ascii nocase
...
rule WEBSHELL_ProxyShell_Exploitation_Nov21_1 {
   meta:
      ...
      date = "2021-11-01"
      score = 85
      uuid = "300eaadf-db0c-5591-84fc-abdf7cdd90c1"
   strings:
