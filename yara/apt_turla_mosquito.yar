...
rule TurlaMosquito_Mal_1 {
   meta:
      ...
      uuid = "1395509a-72f5-56c0-895c-3e9f15829de1"
   strings:
...
rule TurlaMosquito_Mal_2 {
   meta:
      ...
      uuid = "d23d9fe1-26e3-5012-8a88-61ebbc3fbd8f"
   strings:
...
rule TurlaMosquito_Mal_3 {
   meta:
      ...
      uuid = "c83e0a93-3f8d-572d-ac1a-92fef0b3d3f6"
   strings:
...
rule TurlaMosquito_Mal_4 {
   meta:
      ...
      uuid = "1d5c32b3-0316-525c-9386-222917144251"
   condition:
...
rule TurlaMosquito_Mal_5 {
   meta:
      ...
      uuid = "9f3a35c9-b0f0-5ca6-8b34-19e2d45305f2"
   condition:
...
rule TurlaMosquito_Mal_6 {
   meta:
      ...
      uuid = "1c320b60-ec7a-5f87-b871-f55924351f8f"
   strings:
...
rule APT_TurlaMosquito_MAL_Oct22_1 {
   meta:
      ...
      uuid = "f5ad0c0f-81ca-5157-aefb-ead049ada30d"
   strings:
