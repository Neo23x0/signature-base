...
rule remsec_executable_blob_32 {
   meta:
      ...
      uuid = "d7a7e57a-b117-5da8-a7a2-4c6351bd9072"
   strings:
...
rule remsec_executable_blob_64 {
   meta:
      ...
      date = "2016/08/08"
      reference = "http://www.symantec.com/connect/blogs/strider-cyberespionage-group-turns-eye-sauron-targets"
      uuid = "22345f40-3dae-5d5b-acc6-c67394475636"
   strings:
...
rule remsec_executable_blob_parser {
   meta:
      ...
      date = "2016/08/08"
      reference = "http://www.symantec.com/connect/blogs/strider-cyberespionage-group-turns-eye-sauron-targets"
      uuid = "b2189bfe-7b84-5fe9-8829-64f49d1e2030"
   strings:
...
rule remsec_encrypted_api {
   meta:
      ...
      date = "2016/08/08"
      reference = "http://www.symantec.com/connect/blogs/strider-cyberespionage-group-turns-eye-sauron-targets"
      uuid = "1aa3380b-d704-5eb9-b25d-f4bf20ae7179"
   strings:
...
rule remsec_packer_A {
   meta:
      ...
      date = "2016/08/08"
      reference = "http://www.symantec.com/connect/blogs/strider-cyberespionage-group-turns-eye-sauron-targets"
      uuid = "d75198ab-b1ea-572a-a674-9a38c3e2958b"
   strings:
...
rule remsec_packer_B {
   meta:
      ...
      date = "2016/08/08"
      reference = "http://www.symantec.com/connect/blogs/strider-cyberespionage-group-turns-eye-sauron-targets"
      uuid = "18e7f84e-27f2-532d-9ead-0db6e9e6c0b2"
   strings:
