...
rule APT_RANCOR_JS_Malware {
   meta:
      ...
      uuid = "83dd9567-199e-511c-8c9a-96422bd793e7"
   strings:
...
rule APT_RANCOR_PLAINTEE_Variant {
   meta:
      ...
      uuid = "f5b68079-0517-504d-a45f-f6ced532db82"
   strings:
...
rule APT_RANCOR_PLAINTEE_Malware_Exports {
   meta:
      ...
      uuid = "fa1e678d-8357-522b-9167-31321ab7753f"
   condition:
...
rule APT_RANCOR_DDKONG_Malware_Exports {
   meta:
      ...
      date = "2018-06-26"
      hash1 = "c35609822e6239934606a99cb3dbc925f4768f0b0654d6a2adc35eca473c505d"
      uuid = "c94d4ea2-7c16-5003-98ea-253f8a2d01d1"
   condition:
