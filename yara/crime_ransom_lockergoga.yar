...
rule Ransom_LockerGoga_Mar19_1 {
   ...
   strings:
      ...
      $s1 = "cipher.exe" fullword ascii
      $s2 = "netsh.exe" fullword ascii
      $s3 = "net.exe" fullword ascii
   condition:
      ( uint16(0) == 0x5a4d and filesize < 4000KB and 1 of ($x*) or 3 of them ) or $rn1
}
