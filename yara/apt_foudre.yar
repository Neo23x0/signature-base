...
rule Foudre_Backdoor_1 {
   meta:
      ...
      uuid = "ab2d43f4-fc35-5980-9b5d-98c5c4cfd012"
   strings:
...
rule Foudre_Backdoor_Dropper_1 {
   meta:
      ...
      uuid = "38c7d05b-d545-53c5-8db7-a7925b5b7838"
   strings:
...
rule Foudre_Backdoor_Component_1 {
   meta:
      ...
      uuid = "9070f581-64a7-5620-aff4-7f2cbd73099d"
   strings:
...
rule Foudre_Backdoor_SFX {
   meta:
      ...
      uuid = "b5c7cd6b-48c8-5703-b695-19d226de1810"
   strings:
