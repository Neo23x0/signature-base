rule SUSP_Office_Dropper_Strings {
   meta:
      ...
      date = "2018-09-13"
      uuid = "6560fdf7-46e8-5c16-8263-a36f1dec7868"
   strings:
...
rule SUSP_EnableContent_String_Gen {
   meta:
      ...
      uuid = "d763bc21-2925-55df-85e0-1ee857e921ca"
   strings:
...
rule SUSP_WordDoc_VBA_Macro_Strings {
   meta:
      ...
      score = 60
      hash1 = "525ba2c8d35f6972ac8fcec8081ae35f6fe8119500be20a4113900fe57d6a0de"
      uuid = "210baf6e-ec67-5bc4-ba27-6a6de0c11a73"
   strings:
...
rule SUSP_OfficeDoc_VBA_Base64Decode {
   meta:
      ...
      uuid = "99690116-fc89-53d7-8f29-575d75d53fc9"
   strings:
...
rule SUSP_VBA_FileSystem_Access {
   meta:
      ...
      score = 60
      hash1 = "52262bb315fa55b7441a04966e176b0e26b7071376797e35c80aa60696b6d6fc"
      uuid = "91241b91-ca3f-5817-bf78-550fe015b467"
   strings:
...
rule SUSP_Excel_IQY_RemoteURI_Syntax {
   meta:
      ...
      modified = "2023-11-25"
      score = 55
      uuid = "ea3427da-9cce-5ad9-9c78-e3cee802ba80"
   strings:
      $URL = "http"
...
rule SUSP_Macro_Sheet_Obfuscated_Char {
   meta:
      ...
      uuid = "791e9bba-3e4e-5efd-a800-a612c6f92cfb"
   strings:
