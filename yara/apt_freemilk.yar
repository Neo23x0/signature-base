...
rule FreeMilk_APT_Mal_1 {
   meta:
      ...
      uuid = "eff37dba-d4a9-5e3d-9452-49f04ddcbe0b"
   strings:
...
rule FreeMilk_APT_Mal_2 {
   meta:
      ...
      uuid = "ef5f400c-16f8-5374-af16-c8530ddb87ee"
   strings:
...
rule FreeMilk_APT_Mal_3 {
   meta:
      ...
      uuid = "152781f0-756b-50ab-b588-4af5fa4ce419"
   strings:
...
rule FreeMilk_APT_Mal_4 {
   meta:
      ...
      uuid = "44f919f7-8eda-5e70-88d5-9e81a761192c"
   strings:
