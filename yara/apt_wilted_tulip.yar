...
rule WiltedTulip_Tools_back {
   meta:
      ...
      uuid = "3f57bd66-b269-5f59-ade1-f881b1d7dadd"
   strings:
...
rule WiltedTulip_Tools_clrlg {
   meta:
      ...
      uuid = "6957c97d-2c2d-50ac-8fd5-2f299fc7b5c8"
   strings:
...
rule WiltedTulip_powershell {
   meta:
      ...
      uuid = "b6246508-a6ff-5a02-a0de-9cde139f0acc"
   strings:
...
rule WiltedTulip_vminst {
   meta:
      ...
      uuid = "5d21e515-eb7b-56ab-acc2-f09065769b2d"
   strings:
...
rule WiltedTulip_Windows_UM_Task {
   meta:
      ...
      uuid = "d827584e-8298-56e4-8466-90950d1f286e"
   strings:
...
rule WiltedTulip_WindowsTask {
   meta:
      ...
      uuid = "ad8193f0-e664-50a8-ab05-38027a2e33cd"
   strings:
...
rule WiltedTulip_tdtess {
   meta:
      ...
      uuid = "0ecb391b-a4f9-5362-bb65-73801ae497de"
   strings:
...
rule WiltedTulip_SilverlightMSI {
   meta:
      ...
      uuid = "6430d464-b9c7-5f19-b89d-3c70f99af688"
   strings:
...
rule WiltedTulip_matryoshka_Injector {
   meta:
      ...
      uuid = "e4cf2a31-33c8-5db1-84ca-f63b65a0a0a3"
   strings:
...
rule WiltedTulip_Zpp {
   meta:
      ...
      uuid = "7d833cb2-485e-5a26-be2f-aaebde7fdef2"
   strings:
...
rule WiltedTulip_Netsrv_netsrvs {
   meta:
      ...
      uuid = "4b58bb08-88da-535c-8ce5-e7113e5b7045"
   strings:
...
rule WiltedTulip_ReflectiveLoader {
   meta:
      ...
      uuid = "0c7dfb44-8acb-5f36-9683-745560f1f795"
   strings:
...
rule WiltedTulip_Matryoshka_RAT {
   meta:
      ...
      uuid = "e851e212-bb71-55c9-9bc1-0041bb04bef5"
   strings:
