...
rule whosthere_alt {
	meta:
		...
		uuid = "92e98381-9142-58af-82ce-4df9eb0a0039"
	strings:
...
rule iam_alt_iam_alt {
	meta:
		...
		uuid = "cf8ec963-ed23-531e-8ea2-ff9f8643aa75"
	strings:
...
rule genhash_genhash {
	meta:
		...
		uuid = "bec3c014-df3b-5ac0-9501-9b648856e02b"
	strings:
...
rule iam_iamdll {
	meta:
		...
		uuid = "15e8ddac-af17-5509-b552-b4364af57c90"
	strings:
