...
rule APT_UNC2447_MAL_SOMBRAT_May21_1 {
   meta:
      ...
      uuid = "78b46bed-4fd4-596f-bba7-12243f467af3"
   strings:
...
rule APT_UNC2447_MAL_RANSOM_HelloKitty_May21_1 {
   meta:
      ...
      uuid = "c84b2430-dcf1-5a80-96a0-02d292ea386b"
   strings:
...
rule APT_UNC2447_MAL_RANSOM_HelloKitty_May21_2 {
   meta:
      ...
      uuid = "82aaabc6-102a-512e-8c2a-4d6fda864c68"
   strings:
...
rule APT_UNC2447_PS1_WARPRISM_May21_1 {
   meta:
      ...
      uuid = "fa389a45-3b31-5a84-9882-49fd6ee8cac5"
   strings:
...
rule APT_UNC2447_BAT_Runner_May21_1 {
   meta:
      ...
      uuid = "0bacd4f7-421a-570f-9f74-5a19ab806dd0"
   strings:
