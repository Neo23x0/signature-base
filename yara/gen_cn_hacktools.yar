...
rule mswin_check_lm_group {
   meta:
      ...
      uuid = "be17981a-7cbf-55ac-bc81-9330472fc814"
   strings:
...
rule WAF_Bypass {
	meta:
		...
		uuid = "d9f40934-873b-5e73-9198-987966027edc"
	strings:
...
rule Guilin_veterans_cookie_spoofing_tool {
	meta:
		...
		uuid = "13f78e0b-c975-5879-9af1-8c619d6c94a9"
	strings:
...
rule MarathonTool {
	meta:
		...
		uuid = "23513361-ecac-5ddb-92b9-4dd8da12e8db"
	strings:
...
rule PLUGIN_TracKid {
	meta:
		...
		uuid = "8dd77df1-748e-5778-be40-38b794c74b97"
	strings:
...
rule Pc_pc2015 {
	meta:
		...
		uuid = "aa7c0b5e-91c3-52cc-9e06-b4648d0b8825"
	strings:
...
rule sekurlsa {
	meta:
		...
		uuid = "b65dc578-e5a1-57e6-bd98-2c45cd07e857"
	strings:
...
rule mysqlfast {
	meta:
		...
		uuid = "93ee91cd-a6b8-5ed9-b750-779f88032be6"
	strings:
...
rule DTools2_02_DTools {
	meta:
		...
		uuid = "fc812797-12d8-596a-8ebe-dd8b0d7a4b7e"
	strings:
...
rule dll_PacketX {
	meta:
		...
		uuid = "19ab5977-934d-5e3f-8bba-925bb57bf486"
	strings:
...
rule SqlDbx_zhs {
	meta:
		...
		uuid = "31c49755-f1bd-5ecb-91ff-1040e40983ab"
	strings:
...
rule ms10048_x86 {
	meta:
		...
		uuid = "373f0419-5a7d-5f01-968c-5d3e7b1c0670"
	strings:
...
rule Dos_ch {
	meta:
		...
		uuid = "2e8319de-fe54-5083-968c-4707d127f072"
	strings:
...
rule DUBrute_DUBrute {
	meta:
		...
		uuid = "10aa2017-d563-5953-8672-dbc13ff6b3cf"
	strings:
...
rule CookieTools {
	meta:
		...
		uuid = "893884e5-6f4c-5f67-9382-8bf1ee45a257"
	strings:
...
rule update_PcInit {
	meta:
		...
		uuid = "71c34049-97a2-5611-a081-21a85f8631d9"
	strings:
...
rule dat_NaslLib {
	meta:
		...
		uuid = "d5ce72a4-c2b0-50b2-85bb-acf0bfd354e0"
	strings:
...
rule Dos_1 {
	meta:
		...
		uuid = "3f1cc1b3-bce2-5a29-849e-ee7deb5e8809"
	strings:
...
rule OtherTools_servu {
	meta:
		...
		uuid = "b750d090-8726-5d21-98ba-6cb050cb7174"
	strings:
...
rule ustrrefadd {
	meta:
		...
		uuid = "e6701e7e-bb15-5e0c-822b-3e29342e083c"
	strings:
...
rule XScanLib {
	meta:
		...
		uuid = "e1e2cfad-7cbb-51c3-9b55-648c47af641e"
	strings:
...
rule IDTools_For_WinXP_IdtTool {
	meta:
		...
		uuid = "c157d467-87f8-59d5-a3ba-e4fbeeba767d"
	strings:
...
rule GoodToolset_ms11046 {
	meta:
		...
		uuid = "a4703861-02a9-5d93-b6de-c3664ca8abb9"
	strings:
...
rule Cmdshell32 {
	meta:
		...
		uuid = "f1dfb5a1-4292-5895-8310-913cfdf4d9d0"
	strings:
...
rule Sniffer_analyzer_SSClone_1210_full_version {
	meta:
		...
		uuid = "69dac4bf-483d-5888-a748-1a52cf372066"
	strings:
...
rule x64_klock {
	meta:
		...
		uuid = "7065a4fb-c867-5a94-b6bb-5b60085bea15"
	strings:
		$s1 = "Bienvenue dans un processus distant" fullword wide
...
rule Dos_Down32 {
	meta:
		...
		uuid = "e56c254d-1238-5786-8e8a-f9122b0310a9"
	strings:
...
rule MarathonTool_2 {
	meta:
		...
		uuid = "20151673-6779-58ce-872c-81e74a96597d"
	strings:
...
rule scanms_scanms {
	meta:
		...
		uuid = "50393220-35ae-5d3b-ae3f-5d5eb036c043"
	strings:
...
rule CN_Tools_PcShare {
	meta:
		...
		uuid = "0c4e9f9b-9839-56a0-be21-a4e9f19cdfdb"
	strings:
...
rule pw_inspector {
	meta:
		...
		uuid = "888db647-c5d0-5b1b-bcd2-512c1ebeadea"
	strings:
...
rule Dll_LoadEx {
	meta:
		...
		uuid = "51235448-751e-51ce-93f8-da48eddb2b7f"
	strings:
...
rule dat_report {
	meta:
		...
		uuid = "c77633a7-0c2f-5efa-b58b-635546bfec95"
	strings:
...
rule Dos_iis7 {
	meta:
		...
		uuid = "8813b7a2-0d44-5f26-80ab-0f493c09a027"
	strings:
...
rule SwitchSniffer {
	meta:
		...
		uuid = "6019f042-10ab-5899-8b1b-28b2609e9623"
	strings:
...
rule dbexpora {
	meta:
		...
		uuid = "43297ce9-60f3-5b69-b7d8-904fffe622fe"
	strings:
...
rule SQLCracker {
	meta:
		...
		uuid = "7d7ff2cf-81fb-5a04-a97f-577c306137a9"
	strings:
...
rule FreeVersion_debug {
	meta:
		...
		uuid = "2d69a39a-0da5-56ca-87a5-9116dea6c950"
	strings:
...
rule Dos_look {
	meta:
		...
		uuid = "910d1469-9173-5a7d-91ea-a50ee921f662"
	strings:
...
rule NtGodMode {
	meta:
		...
		uuid = "3de620bf-0405-536b-9f6d-3a7f02417b20"
	strings:
...
rule WebCrack4_RouterPasswordCracking {
	meta:
		...
		uuid = "e3d50ff8-e58d-5c60-9acd-25ba95a21f68"
	strings:
...
rule hscan_gui {
	meta:
		...
		uuid = "27f9d2e9-0a62-57ca-9061-c32945c59c7e"
	strings:
...
rule S_MultiFunction_Scanners_s {
	meta:
		...
		uuid = "7fb90a59-116d-5fa7-b85b-cbb1af660666"
	strings:
...
rule HKTL_CN_Dos_GetPass {
	meta:
		...
		uuid = "08635096-474c-5fdf-825e-6c7c8c8d4061"
	strings:
		$s0 = "GetLogonS" ascii
...
rule HKTL_CN_update_PcMain {
   meta:
      ...
      uuid = "24c9ba6f-0772-59c9-8bea-3a8bf7823e4c"
   strings:
...
rule HKTL_CN_Dos_sys {
	meta:
		...
		uuid = "c4b740f2-f4f8-59ff-ad1f-c06718040b50"
	strings:
...
rule HKTL_CN_dat_xpf {
	meta:
		...
		uuid = "fe2de535-4f86-5c29-b67e-153423a897f7"
	strings:
...
rule HKTL_CN_Project1 {
	meta:
		...
		uuid = "12cc7a82-d7a9-58c6-b283-3bb0df477cd8"
	strings:
...
rule Arp_EMP_v1_0 {
	meta:
		...
		uuid = "b2552f26-47ac-5fa0-941e-d674f9deccac"
	strings:
...
rule CN_Tools_MyUPnP {
	meta:
		...
		uuid = "394e19d3-882e-5a7c-a3a0-e662bd67955c"
	strings:
...
rule CN_Tools_Shiell {
	meta:
		...
		uuid = "7ac7d79d-3f4e-54e7-bb97-ce94cbbb40a2"
	strings:
...
rule cndcom_cndcom {
	meta:
		...
		uuid = "b1acfe34-03b8-5909-a226-3325fe8629ab"
	strings:
...
rule IsDebug_V1_4 {
	meta:
		...
		uuid = "f9b4a909-e0e5-5708-8794-39250b9d56cc"
	strings:
...
rule HTTPSCANNER {
	meta:
		...
		uuid = "470c90f5-bb98-59ab-bff4-f6238c318e36"
	strings:
...
rule HScan_v1_20_PipeCmd {
	meta:
		...
		uuid = "957a8e3b-5f6c-5f3e-8973-88259c9cb0dc"
	strings:
...
rule Dos_fp {
	meta:
		...
		uuid = "f4427aab-50c3-5bb9-997a-75e162a83f8a"
	strings:
...
rule Dos_netstat {
	meta:
		...
		uuid = "bc3141bf-4e82-5aa4-a8a6-a0a4586ee9a1"
	strings:
...
rule CN_Tools_xsniff {
	meta:
		...
		uuid = "a0fdac88-a7b8-5d24-9012-2bfe7b07e675"
	strings:
...
rule MSSqlPass {
	meta:
		...
		uuid = "d45b417f-3649-5603-bd19-8b8bcc19dabc"
	strings:
...
rule WSockExpert {
	meta:
		...
		uuid = "0ae115be-c516-5f4a-97ce-555d84f42947"
	strings:
...
rule Ms_Viru_racle {
	meta:
		...
		uuid = "bdc78dcc-79e6-5516-bba2-54bf537eae38"
	strings:
...
rule lamescan3 {
	meta:
		...
		uuid = "8ff1a0e6-d054-589d-a038-f889951ba250"
	strings:
...
rule CN_Tools_pc {
	meta:
		...
		uuid = "11cc6c46-33c0-5c53-88f8-700be9ca8add"
	strings:
		$s0 = "\\svchost.exe" ascii
		$s2 = "%s%08x.001" fullword ascii
...
rule Dos_Down64 {
	meta:
		...
		uuid = "b4907ede-dc6a-5b8c-bf1c-557df54191a4"
	strings:
...
rule epathobj_exp32 {
	meta:
		...
		uuid = "ca4639af-ee4f-5220-9595-e7a06b9a8534"
	strings:
...
rule Tools_unknown {
	meta:
		...
		uuid = "2cb75a84-506d-5b67-8b1f-b91beb5a99a3"
	strings:
...
rule PLUGIN_AJunk {
	meta:
		...
		uuid = "af92d01d-5e24-52f7-934a-0ad102fc7a93"
	strings:
...
rule IISPutScanner {
	meta:
		...
		uuid = "699ee45d-c842-56eb-b55b-12a91e815a7b"
	strings:
		$s2 = "KERNEL32.DLL" fullword ascii
...
rule IDTools_For_WinXP_IdtTool_2 {
	meta:
		...
		uuid = "0312be49-c262-5143-abfc-02d428552b86"
	strings:
...
rule hkmjjiis6 {
	meta:
		...
		uuid = "9618c6ec-1557-5b1b-bebc-1c220bb3aba4"
	strings:
...
rule Dos_lcx {
	meta:
		...
		uuid = "2f443673-bfed-5ce3-a0e6-6b59f27c9658"
	strings:
...
rule x_way2_5_X_way {
	meta:
		...
		uuid = "8e878671-2a7c-5c6e-a905-05d303f42e0f"
	strings:
...
rule tools_Sqlcmd {
	meta:
		...
		uuid = "26e29826-d4bb-55d0-9331-a91e4473daca"
	strings:
...
rule Sword1_5 {
	meta:
		...
		uuid = "dff8666a-0373-5605-9012-92b2b3ec71ea"
	strings:
...
rule Tools_scan {
	meta:
		...
		uuid = "4601d4d0-2b7e-5937-87b6-df80ab373752"
	strings:
...
rule arpsniffer {
	meta:
		...
		uuid = "78db3b18-008a-5a4e-9504-0cbe3b852046"
	strings:
		$s1 = "SHELL" ascii
...
rule pw_inspector_2 {
	meta:
		...
		uuid = "795c7009-93a8-57c4-8554-f0ed5c1d50f8"
	strings:
...
rule datPcShare {
	meta:
		...
		uuid = "1bf44c0d-6aa7-5486-baee-c17d3e82403f"
	strings:
...
rule Tools_xport {
	meta:
		...
		uuid = "3223fe5b-6135-5530-a5eb-10c44f3f6277"
	strings:
...
rule Pc_xai {
	meta:
		...
		uuid = "dcf1b57b-3616-5198-bd57-18505fee91ae"
	strings:
...
rule Radmin_Hash {
	meta:
		...
		uuid = "07761e81-15b4-5639-b766-8dc3f16e2b7a"
	strings:
...
rule OSEditor {
	meta:
		...
		uuid = "b308852c-3436-5748-9ba6-82d4c3c5fc14"
	strings:
...
rule GoodToolset_ms11011 {
	meta:
		...
		uuid = "689b7ea3-6707-5f99-8232-438d903d414d"
	strings:
...
rule FreeVersion_release {
	meta:
		...
		uuid = "1a603634-a00a-5f8b-a47d-c3c8065a5c3e"
	strings:
		$s1 = "-->Got WMI process Pid: %d " ascii
...
rule churrasco {
	meta:
		...
		uuid = "99cb5a7a-85c1-57f5-b5b6-f0b1092e1e06"
	strings:
...
rule x64_KiwiCmd {
	meta:
		...
		uuid = "df759fd4-5d42-5dd9-81d0-ceccafcdd64d"
	strings:
...
rule sql1433_SQL {
	meta:
		...
		uuid = "fb4c5958-2e4e-5231-b0db-eca6bc3d823a"
	strings:
...
rule CookieTools2 {
	meta:
		...
		uuid = "f227ba4b-9cad-5aac-99ab-46a8237249d4"
	strings:
...
rule cyclotron {
	meta:
		...
		uuid = "7099462b-2a72-56cd-8a50-27cd445eb9d2"
	strings:
...
rule xscan_gui {
	meta:
		...
		uuid = "fee11058-e75f-5d8f-8d10-06dcaed99df1"
	strings:
...
rule CN_Tools_hscan {
	meta:
		...
		uuid = "82d9cd61-8cef-56b4-8dfe-a28edaa781b8"
	strings:
...
rule GoodToolset_pr {
	meta:
		...
		uuid = "d00e1873-f2a5-5e89-9223-ead418e2667c"
	strings:
		$s1 = "-->Got WMI process Pid: %d " ascii
...
rule hydra_7_4_1_hydra {
	meta:
		...
		uuid = "cf692bea-091d-5be0-a012-caba01e96dde"
	strings:
...
rule CN_Tools_srss_2 {
	meta:
		...
		uuid = "3a84fa58-ccd0-5cf0-b1e0-a8f2ca04fd3f"
	strings:
...
rule Dos_NtGod {
	meta:
		...
		uuid = "c2f0733d-5519-5cb8-b077-0ae8472400b4"
	strings:
...
rule CN_Tools_VNCLink {
	meta:
		...
		uuid = "270dc14c-ac8f-58c2-b4ac-c10981e20a07"
	strings:
...
rule tools_NTCmd {
	meta:
		...
		uuid = "db3f28d6-dfe8-5c79-a11b-e31701e250d7"
	strings:
...
rule mysql_pwd_crack {
	meta:
		...
		uuid = "3ddeb1c7-e124-5e9e-abcf-3856e0561165"
	strings:
...
rule CmdShell64 {
	meta:
		...
		uuid = "f4d69be7-f717-53f7-873e-86acbb309106"
	strings:
...
rule Ms_Viru_v {
	meta:
		...
		uuid = "88a01e7a-8210-5e0c-a9b8-b7c9b991e16b"
	strings:
...
rule CN_Tools_Vscan {
	meta:
		...
		uuid = "2d73d9c9-62cd-592f-a44e-0a0456c85a3c"
	strings:
...
rule IISPutScannesr {
	meta:
		...
		uuid = "c5d358e8-955f-5b96-89e7-eb0b6c4d0af0"
	strings:
		$s1 = "yoda & M.o.D." ascii
...
rule HKTL_Unknown_CN_Generate {
	meta:
		...
		uuid = "88ad2c71-519f-58b0-87f8-a6f54a54a774"
	strings:
		$s1 = "C:\\TEMP\\" ascii
...
rule Pc_rejoice {
	meta:
		...
		uuid = "197b5a21-e1ed-5ea8-b7f2-e84684aedc54"
	strings:
...
rule ms11080_withcmd {
	meta:
		...
		uuid = "fa5002ac-d6e6-543f-8020-43dfae689b3b"
	strings:
...
rule OtherTools_xiaoa {
	meta:
		...
		uuid = "a456d373-2063-5264-8cf4-d0a5918392fc"
	strings:
...
rule unknown2 {
	meta:
		...
		uuid = "af7ddcbf-1cba-51a9-b435-9a267320f502"
	strings:
...
rule hydra_7_3_hydra {
	meta:
		...
		uuid = "70e9a5bf-ce2d-58ab-8bdc-257e2aa5e917"
	strings:
...
rule OracleScan {
	meta:
		...
		uuid = "142c0ed1-0752-54c3-9a4b-68e656c32939"
	strings:
...
rule SQLTools {
	meta:
		...
		uuid = "bddb7956-abc1-58b6-8a6d-eb482be99f42"
	strings:
...
rule HKTL_Portscanner_533_NET_Jun15 {
	meta:
		...
		uuid = "c834203d-6d4d-5242-9b1e-b64fa6560ccd"
	strings:
...
rule kappfree {
	meta:
		...
		uuid = "eb9c1324-5d82-57ab-bd48-98c984b45b32"
	strings:
		$s1 = "Bienvenue dans un processus distant" fullword wide
...
rule Smartniff {
	meta:
		...
		uuid = "3d169126-1b43-5545-a106-7c38a6a49499"
	strings:
...
rule ChinaChopper_caidao {
	meta:
		...
		uuid = "c56eb3e5-e916-535b-bf87-88a9ae94c359"
	strings:
...
rule KiwiTaskmgr_2 {
	meta:
		...
		uuid = "ea021257-8ced-5131-a00a-be014b4112fb"
	strings:
		$s1 = "Process Ok, Memory Ok, resuming process :)" fullword wide
...
rule kappfree_2 {
	meta:
		...
		uuid = "6c7b4a99-b5ab-5fd6-b130-7c30b84b7171"
	strings:
...
rule x_way2_5_sqlcmd {
	meta:
		...
		uuid = "c6b4dae2-38cb-5cf9-b980-df5ebefbe7ad"
	strings:
...
rule Win32_klock {
	meta:
		...
		uuid = "dd17a8e2-54af-5967-937a-d83feceab891"
	strings:
...
rule ipsearcher {
	meta:
		...
		uuid = "bb33535a-e8cc-545d-bee8-3c31902eedb9"
	strings:
...
rule ms10048_x64 {
	meta:
		...
		uuid = "8c9bcf72-1bc7-57ed-9e0b-09d113a8c704"
	strings:
...
rule hscangui {
	meta:
		...
		uuid = "f0993510-70ee-52c6-a7b8-e023eb4b33ee"
	strings:
...
rule GoodToolset_ms11080 {
	meta:
		...
		uuid = "080e04a3-5cbe-57a8-9106-539451922cb4"
	strings:
...
rule epathobj_exp64 {
	meta:
		...
		uuid = "cb56bbdc-8afa-5b4b-b7df-942dd3d60366"
	strings:
...
rule kelloworld_2 {
	meta:
		...
		uuid = "3f298004-e618-5f4a-9cd7-c7c954b6fc64"
	strings:
...
rule HScan_v1_20_hscan {
	meta:
		...
		uuid = "4183824c-b77f-5500-a962-8d9dc78a9388"
	strings:
		$s1 = "[%s]: Found \"FTP account: anyone/anyone@any.net\"  !!!" fullword ascii
...
rule _Project1_Generate_rejoice {
	meta:
		...
		uuid = "4b36d450-1194-527c-8565-7f321d486d01"
	strings:
...
rule _hscan_hscan_hscangui {
	meta:
		...
		uuid = "174b0ee4-23ce-59fd-a784-ab58fd13ce67"
	strings:
...
rule kiwi_tools {
	meta:
		...
		uuid = "000f0081-b035-5c73-8da2-addde2b55303"
	strings:
...
rule kiwi_tools_gentil_kiwi {
	meta:
		...
		uuid = "4ad54580-b10b-5b17-8d8a-510e210e04d1"
	strings:
