...
rule Reaver3_Malware_Nov17_1 {
   meta:
      ...
      uuid = "95419d6f-b657-53c4-840d-9a9e9b00787e"
   strings:
...
rule Reaver3_Malware_Nov17_2 {
   meta:
      ...
      uuid = "423ae050-5087-528e-be0a-c612024dc70a"
   strings:
...
rule Reaver3_Malware_Nov17_3 {
   meta:
      ...
      uuid = "cc2511a9-8938-5f4d-9802-f73e44609bf9"
   strings:
...
rule SunOrcal_Malware_Nov17_1 {
   meta:
      ...
      uuid = "d8a21570-d1d6-52c3-abb2-ecaa86eb7ff0"
   strings:
