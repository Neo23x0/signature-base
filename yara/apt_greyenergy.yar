...
rule APT_GreyEnergy_Malware_Oct18_1 {
   meta:
      ...
      uuid = "fc997540-075e-5f1c-9238-135c1572553b"
   strings:
...
rule APT_GreyEnergy_Malware_Oct18_2 {
   meta:
      ...
      uuid = "50830741-ba3d-505c-bb21-8cedc2162f96"
   strings:
...
rule APT_GreyEnergy_Malware_Oct18_3 {
   meta:
      ...
      uuid = "cc365dbf-1448-5219-95f5-d1154000f52d"
   strings:
...
rule APT_GreyEnergy_Malware_Oct18_4 {
   meta:
      ...
      uuid = "1a2df257-a639-5868-a005-690d64cfbf2b"
   strings:
...
rule APT_GreyEnergy_Malware_Oct18_5 {
   meta:
      ...
      uuid = "a8c4517d-912d-5264-b9ab-acdf37fc4d56"
   strings:
