...
rule M_APT_VIRTUALPITA_1
{
       meta:
             ...
             uuid = "bdfbe29a-f7db-50d9-a909-d4ca96cc0731"
      strings:
...
rule M_APT_VIRTUALPITA_2
{
       meta:
             ...
             uuid = "6a59cc54-e1a0-594f-9efb-af63d5c05259"
      strings:
...
rule M_APT_VIRTUALPITA_3
{
       meta:
             ...
             uuid = "29ea2db0-4ab2-5e9c-8d42-7590ceabf99a"
      strings:
...
rule M_APT_VIRTUALPITA_4
{
       meta:
             ...
             uuid = "58d4db75-fcd5-50c2-93ba-a8a4718ac0f6"
      strings:
...
rule M_Hunting_Python_Backdoor_CommandParser_1
{
      meta:
            ...
            uuid = "15cbca01-24e6-5538-bcfd-c3222337aaf5"
      strings:
