...
rule APT17_Malware_Oct17_1 {
   meta:
      ...
      uuid = "457312d8-5bfe-5282-9ace-2f169278569c"
   strings:
...
rule APT17_Malware_Oct17_2 {
   meta:
      ...
      uuid = "9f21514a-168b-5158-8322-60fa8499b11a"
   strings:
...
rule APT17_Unsigned_Symantec_Binary_EFA {
   meta:
      ...
      uuid = "56eec517-8b00-5cb5-9806-249e50f53b99"
   strings:
...
rule APT17_Malware_Oct17_Gen {
   meta:
      ...
      uuid = "c2156e68-d5b5-5bd7-858c-2d5e90199287"
   strings:
