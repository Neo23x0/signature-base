...
rule FVEY_ShadowBroker_Auct_Dez16_Strings {
  meta:
     ...
     date = "2016-12-17"
     uuid = "b1454c5d-01bc-599b-815c-aa1a3c52be3f"
  strings:
...
rule FVEY_ShadowBroker_violetspirit {
   meta:
      ...
      uuid = "4efea734-8cbc-53f7-bf92-5b3253721a81"
   strings:
...
rule FVEY_ShadowBroker_gr_gr {
   meta:
      ...
      uuid = "c233159d-8d78-575b-b32b-21f704debfe2"
   strings:
...
rule FVEY_ShadowBroker_user_tool_yellowspirit {
   meta:
      ...
      uuid = "b1ca04e5-bac7-5247-b2d4-82c3515c92fc"
   strings:
...
rule FVEY_ShadowBroker_eleganteagle_opscript_1_0_0 {
   meta:
      ...
      uuid = "22855519-160c-57cf-b610-a611ca6813ed"
   strings:
...
rule FVEY_ShadowBroker_opscript {
   meta:
      ...
      uuid = "d00752a3-d5c2-53a7-9a83-ad31cfb534af"
   strings:
...
rule FVEY_ShadowBroker_user_tool_dubmoat {
   meta:
      ...
      uuid = "d6c0a00b-dda9-587f-a867-f3b632edd494"
   strings:
...
rule FVEY_ShadowBroker_strifeworld {
   meta:
      ...
      uuid = "a15c2034-8394-5e62-a5f0-d1506c19e585"
   strings:
...
rule FVEY_ShadowBroker_user_tool_pork {
   meta:
      ...
      uuid = "ee5f88b1-6e58-5288-8b80-0d3d188e1ac6"
   strings:
...
rule FVEY_ShadowBroker_user_tool_ebbisland {
   meta:
      ...
      uuid = "fd312ba2-d590-5007-875c-008553c2b1b9"
   strings:
...
rule FVEY_ShadowBroker_user_tool_stoicsurgeon {
   meta:
      ...
      uuid = "2ff22b17-4922-54d7-bbd8-a5ff40b6ebe5"
   strings:
...
rule FVEY_ShadowBroker_user_tool_elgingamble {
   meta:
      ...
      uuid = "344e5d5e-9fd6-5a32-ba98-945f5a35a116"
   strings:
...
rule FVEY_ShadowBroker_README_cup {
   meta:
      ...
      uuid = "876f3d99-cc6d-568a-a202-1b4938436303"
   strings:
...
rule FVEY_ShadowBroker_nopen_oneshot {
   meta:
      ...
      uuid = "6a6b5426-f559-5668-a2ed-982801933302"
   strings:
...
rule FVEY_ShadowBroker_user_tool_earlyshovel {
   meta:
      ...
      uuid = "d2640f9f-8934-5095-9c30-f24941685c9e"
   strings:
...
rule FVEY_ShadowBroker_user_tool_envisioncollision {
   meta:
      ...
      uuid = "a738e270-a3ea-5d38-8933-797d1bd9036a"
   strings:
...
rule FVEY_ShadowBroker_Gen_Readme1 {
   meta:
      ...
      uuid = "1f5e3ab1-e0d1-589e-8c18-60c4ad07ee6e"
   strings:
...
rule FVEY_ShadowBroker_Gen_Readme2 {
   meta:
      ...
      uuid = "5959d881-2989-582c-abe2-48c76ce0e995"
   strings:
...
rule FVEY_ShadowBroker_Gen_Readme3 {
   meta:
      ...
      uuid = "41cfbf66-fb7d-5815-939f-06b23dfae746"
   strings:
...
rule FVEY_ShadowBroker_Gen_Readme4 {
   meta:
      ...
      uuid = "9e84e4ab-f74a-59e5-aee2-408a68cd673f"
   strings:
