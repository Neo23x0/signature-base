...
rule CobaltStrike_CN_Group_BeaconDropper_Aug17 {
   meta:
      ...
      uuid = "5631b0bc-9e25-524a-9003-73779fd492f7"
   strings:
...
rule CobaltGang_Malware_Aug17_1 {
   meta:
      ...
      uuid = "56c6f4f8-ccf5-5665-ac21-67f0a9b67cf1"
   strings:
...
rule CobaltGang_Malware_Aug17_2 {
   meta:
      ...
      uuid = "2839c119-0fa4-51f0-a406-5d381cc594a2"
   strings:
...
rule MAL_CRIME_CobaltGang_Malware_Oct19_1 {
   meta:
      ...
      uuid = "95c16016-b09b-56f3-b5a4-fca18ac70ad5"
   strings:
