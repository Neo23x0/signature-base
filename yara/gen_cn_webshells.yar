...
rule Shell_Php {
    meta:
        description = "Chinese Hacktool Set Webshells - file Php.htm"
        author = "Florian Roth"
        reference = "http://tools.zjqhr.com/"
        date = "2015-06-14"
        hash = "f169554102244dc29b4fceb796f30f8b2205bd95"
    strings:
        $s1 = "eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a" ascii
    condition:
        filesize < 40KB and all of them
}
