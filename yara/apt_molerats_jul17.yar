...
rule Molerats_Jul17_Sample_1 {
   meta:
      ...
      uuid = "b5277255-3ced-5dc5-9490-c5829a0c248b"
   strings:
...
rule Molerats_Jul17_Sample_2 {
   meta:
      ...
      uuid = "7ef02003-83d1-5ec7-952d-1e693375dd4b"
   strings:
...
rule Molerats_Jul17_Sample_3 {
   meta:
      ...
      uuid = "e1a3323e-fe84-59e5-86d9-dca0c261e3c3"
   strings:
...
rule Molerats_Jul17_Sample_4 {
   meta:
      ...
      uuid = "cad0c6a2-d286-52fa-b9b8-793ab9ae048f"
   strings:
...
rule Molerats_Jul17_Sample_5 {
   meta:
      ...
      date = "2017-07-07"
      hash1 = "ebf2423b9de131eab1c61ac395cbcfc2ac3b15bd9c83b96ae0a48619a4a38d0a"
      uuid = "c9dd4f4a-a980-5339-b238-9f53360b89ae"
   strings:
...
rule Molerats_Jul17_Sample_Dropper {
   meta:
      ...
      uuid = "b4622373-b496-51de-abaa-caa665b558b3"
   strings:
