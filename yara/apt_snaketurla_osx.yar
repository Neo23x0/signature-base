...
rule SnakeTurla_Malware_May17_1 {
   meta:
      ...
      uuid = "ddbbd602-b7f0-5e14-be0f-0c84bb22ddeb"
   strings:
...
rule SnakeTurla_Malware_May17_2 {
   meta:
      ...
      uuid = "b3e94016-591c-5e39-b5e7-328e0761e535"
   strings:
...
rule SnakeTurla_Malware_May17_4 {
   meta:
      ...
      uuid = "797dedd6-a13e-529f-bae4-4043294672c4"
   strings:
...
rule SnakeTurla_Installd_SH {
   meta:
      ...
      reference = "https://goo.gl/QaOh4V"
      date = "2017-05-04"
      uuid = "65a97c0d-5c69-5e58-9a18-10e5684bc218"
   strings:
...
rule SnakeTurla_Install_SH {
   meta:
      ...
      reference = "https://goo.gl/QaOh4V"
      date = "2017-05-04"
      uuid = "68775c54-46f8-5d44-ba63-6726d2bb8016"
   strings:
