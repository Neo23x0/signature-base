...
rule APT_MAL_VEILEDSIGNAL_Backdoor_Apr23 {
   meta:
      ...
      uuid = "74c403ea-3178-58e8-88b3-a51c1d475868"
    strings:
...
rule SUSP_APT_MAL_VEILEDSIGNAL_Backdoor_Apr23 {
   meta:
      ...
      score = 75
      hash1 = "aa318070ad1bf90ed459ac34dc5254acc178baff3202d2ea7f49aaf5a055dd43"
      uuid = "8f0d92b6-d9b0-55e3-b2ca-601d095f5279"
   strings:
...
rule APT_NK_MAL_M_Hunting_VEILEDSIGNAL_1 {
   meta:
      ...
      reference = "https://www.mandiant.com/resources/blog/3cx-software-supply-chain-compromise"
      date = "2023-04-20"
      uuid = "3e7c92fe-a7bd-5180-9935-4f98f2b64e2b"
   strings:
...
rule APT_NK_MAL_M_Hunting_VEILEDSIGNAL_2 {
   meta:
      ...
      reference = "https://www.mandiant.com/resources/blog/3cx-software-supply-chain-compromise"
      date = "2023-04-20"
      uuid = "1b96c2f0-1c57-593e-9630-a72d43eb857e"
   strings:
...
rule APT_NK_MAL_M_Hunting_VEILEDSIGNAL_3 {
   meta:
      ...
      reference = "https://www.mandiant.com/resources/blog/3cx-software-supply-chain-compromise"
      date = "2023-04-20"
      uuid = "82790c65-1d93-509b-95df-841543943c30"
   strings:
...
rule APT_NK_MAL_M_Hunting_VEILEDSIGNAL_4 {
   meta:
      ...
      reference = "https://www.mandiant.com/resources/blog/3cx-software-supply-chain-compromise"
      date = "2023-04-20"
      uuid = "379e6471-3c4f-5c72-b8fd-17f481e89ac6"
   strings:
...
rule APT_NK_MAL_M_Hunting_VEILEDSIGNAL_5 {
   meta:
      ...
      reference = "https://www.mandiant.com/resources/blog/3cx-software-supply-chain-compromise"
      date = "2023-04-20"
      uuid = "7d0718fc-4f1c-5293-8dc4-81a5783fbfb2"
   strings:
...
rule APT_NK_MAL_M_Hunting_VEILEDSIGNAL_6 {
   meta:
      ...
      reference = "https://www.mandiant.com/resources/blog/3cx-software-supply-chain-compromise"
      date = "2023-04-20"
      uuid = "2cbedbc0-d465-5674-bf9c-9362003eb8d2"
   strings:
...
rule SUSP_NK_MAL_M_Hunting_POOLRAT {
   meta:
      ...
      reference = "https://www.mandiant.com/resources/blog/3cx-software-supply-chain-compromise"
      date = "2023-04-20"
      uuid = "70f5f3a0-0fd0-54dc-97cc-4f3c35f02fcd"
   strings:
      /*
...
rule APT_NK_TradingTech_ForensicArtifacts_Apr23_1 {
   meta:
      ...
      modified = "2023-04-21"
      score = 60
      uuid = "f79a5321-4f22-52d9-aa83-4aa750ecc036"
   strings:
...
rule SUSP_TH_APT_UNC4736_TradingTech_Cert_Apr23_1 {
   meta:
      ...
      date = "2023-04-20"
      score = 65
      uuid = "9a05fba9-9466-5b69-9207-27ad01d6eb8b"
   strings:
