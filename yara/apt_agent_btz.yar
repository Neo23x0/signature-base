...
rule Agent_BTZ_Proxy_DLL_1 {
   meta:
      ...
      uuid = "f8032616-2a54-5107-b330-65fcc84b866e"
   strings:
...
rule Agent_BTZ_Proxy_DLL_2 {
   meta:
      ...
      uuid = "2777443d-6f63-5948-855a-e064a6e0310f"
   strings:
...
rule Agent_BTZ_Aug17 {
   meta:
      ...
      uuid = "31804208-3edb-554b-8820-e682db647435"
   strings:
...
rule APT_Turla_Agent_BTZ_Gen_1 {
   meta:
      ...
      uuid = "d5e1dd3d-4f03-5f79-898b-e612d2758b60"
   strings:
