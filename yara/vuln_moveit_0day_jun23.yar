...
rule WEBSHELL_ASPX_DLL_MOVEit_Jun23_1 {
   meta:
      ...
      uuid = "47db8602-9a9e-5efc-b8b9-fbc4f3c8d4e9"
   strings:
...
rule WEBSHELL_ASPX_MOVEit_Jun23_1 {
   meta:
      ...
      uuid = "2c789b9c-5ec5-5fd1-84e3-6bf7735a9488"
   strings:
...
rule LOG_EXPL_MOVEit_Exploitation_Indicator_Jun23_1 {
   meta:
      ...
      date = "2023-06-01"
      score = 70
      uuid = "a7c521b8-c654-51dd-9d5b-4ba883feffe3"
   strings:
...
rule LOG_EXPL_MOVEit_Exploitation_Indicator_Jun23_2 {
   meta:
      ...
      date = "2023-06-03"
      score = 70
      uuid = "1527f5e3-071d-5152-9452-9c4472d258f2"
   strings:
...
rule LOG_EXPL_MOVEit_Exploitation_Indicator_Jun23_3 {
   meta:
      ...
      date = "2023-06-13"
      score = 70
      uuid = "113a501f-d9ed-51fd-82cd-ccb6f02833bd"
   strings:
