...
rule MAL_Trickbot_Oct19_1 {
   meta:
      ...
      uuid = "b428cbf9-0796-5a01-9b98-28e1bc6827cc"
   strings:
...
rule MAL_Trickbot_Oct19_2 {
   meta:
      ...
      uuid = "2ff69a51-d089-53e5-ab19-4fbdf20f90f8"
   strings:
...
rule MAL_Trickbot_Oct19_3 {
   meta:
      ...
      uuid = "3428b7e3-def9-5574-bbbb-6ba98c134dec"
   strings:
...
rule MAL_Trickbot_Oct19_4 {
   meta:
      ...
      uuid = "dcadaa50-52ae-5ded-b40e-149f28092093"
   strings:
...
rule MAL_Trickbot_Oct19_5 {
   meta:
      ...
      uuid = "b3034f0c-5fd9-58a2-866f-9100e3a56f39"
   strings:
...
rule MAL_Trickbot_Oct19_6 {
   meta:
      ...
      uuid = "5feb8d34-4974-5315-a5f9-79a3fac83d1d"
   strings:
