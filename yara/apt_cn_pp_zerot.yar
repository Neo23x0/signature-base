...
rule PP_CN_APT_ZeroT_1 {
   meta:
      ...
      uuid = "c16f3abb-ac7e-5d5f-b8d7-b105cff3886e"
   strings:
...
rule PP_CN_APT_ZeroT_2 {
   meta:
      ...
      uuid = "8433216e-1189-568c-bd18-051fb1fec215"
   strings:
...
rule PP_CN_APT_ZeroT_3 {
   meta:
      ...
      uuid = "99aa29cf-d962-5a3d-bd28-6486c40822bb"
   strings:
...
rule PP_CN_APT_ZeroT_4 {
   meta:
      ...
      uuid = "b21961ee-d346-51d3-bacd-02554240162d"
   strings:
...
rule PP_CN_APT_ZeroT_5 {
   meta:
      ...
      uuid = "2a7c6a36-aace-562e-bbc4-425c1d93fab1"
   strings:
...
rule PP_CN_APT_ZeroT_6 {
   meta:
      ...
      uuid = "2e3bb4bd-5e20-56e7-a82b-d717d83eaeeb"
   strings:
...
rule PP_CN_APT_ZeroT_7 {
   meta:
      ...
      uuid = "e9cdca86-84a8-5673-935c-c319b523674b"
   strings:
...
rule PP_CN_APT_ZeroT_8 {
   meta:
      ...
      uuid = "f9a4f092-c699-5e91-9667-64ffe1b02bc1"
   strings:
      $s1 = "/svchost.exe" fullword ascii
      $s2 = "RasTls.dll" fullword ascii
      $s3 = "20160620.htm" fullword ascii
...
rule PP_CN_APT_ZeroT_9 {
   meta:
      ...
      uuid = "e1c32993-409c-5a62-8239-cff99fb83a7f"
   strings:
...
rule CN_APT_ZeroT_nflogger {
   meta:
      ...
      uuid = "0d23f312-e3b6-5c23-855b-25ae54265512"
   strings:
...
rule CN_APT_ZeroT_extracted_Go {
   meta:
      ...
      uuid = "ba929e6d-4162-58e7-b8a8-bcb066b64522"
   strings:
...
rule CN_APT_ZeroT_extracted_Mcutil {
   meta:
      ...
      uuid = "c887d36b-8aeb-54f1-a683-727561723238"
   strings:
...
rule CN_APT_ZeroT_extracted_Zlh {
   meta:
      ...
      uuid = "4c8b9a90-6cb3-5aba-a993-f73207341d0e"
   strings:
