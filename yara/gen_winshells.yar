...
rule WindowsShell_s3 {
	meta:
		...
		uuid = "064754a7-8639-5dbd-93f3-906662b8e9bc"
	strings:
...
rule WindosShell_s1 {
	meta:
		...
		uuid = "b4e783a2-4a93-5c72-9b09-4692b383ac00"
	strings:
...
rule WindowsShell_s4 {
	meta:
		...
		uuid = "838771dc-f885-5332-9813-2bc01af8e5fe"
	strings:
		$s1 = "cmd                  - execute cmd.exe" fullword ascii
		$s2 = "\\\\.\\pipe\\%08X" fullword ascii
		$s3 = "get <remote> <local> - download file" fullword ascii
...
rule WindowsShell_Gen {
	meta:
		...
		uuid = "6b871e8a-8fe3-5cc6-9f2c-ba2359861ea1"
	strings:
...
rule WindowsShell_Gen2 {
	meta:
		...
		uuid = "8ed8443d-491b-5cb0-b12b-0d25267ba462"
	strings:
		$s1 = "cmd                  - execute cmd.exe" fullword ascii
